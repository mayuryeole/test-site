    ...
    <div class="login_form otp_verification">
        <div class="row">           
            <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                ?>
                <form class="form_login" role="form" method="POST" action="{{ url('get/register-user/otp') }}">
                    {!! csrf_field() !!}
...
<!--                            @if($error != '')
                    ...
                    <div class="form-group">
                        <button type="submit" class="login_btn">Verify</button>
                    </div>
                     <p class="create_ac_link restnd_opt text-center">
                        <a href="{{url('get-user/update_resend-otp')}}/{{ $user_id }}">Resend OTP</a>
                    </p>
                    <p class="create_ac_link text-center back_otp_btn"><a href="{{url('back_to_register')}}/{{$user_id}}"><i class="fa fa-backward"></i> Back</a></p>
                </form>
            </div>
        </div>
    </div>
