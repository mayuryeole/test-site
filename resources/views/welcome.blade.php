        ...
        <div class="item">
            <div class="mobile-wed-categories">
                <a href="{{ url('/rivaah-story') }}/{{ $riv_img_gal->id }}">
                    ...
                    <div class="mobile-wed-head">{{ $rivaah[$cnt]['name'] }}</div>
                </a>
            </div>
        </div>
                @php $cnt++; @endphp
                                        ...
                                        <div class="panel panel-default">
                                            ...
                                            <div id="collapseOne-{{ $prods->id }}" class="panel-collapse collapse" role="tabpanel">
                                                <div class="panel-body">
                                                    <p>{{ $prods->productDescription->description }}</p>
                                                    <a href="{{ url('/product').'/'.$prods->id }}" type="button" class="cust-btn">Shop Now</a>
                                                </div>
                                            </div>
                                        </div>
                                    @endforeach
        ...
        <div class="best_pro_blk">
            <div class="row">
                ...
                <div class="col-md-4 col-sm-4 col-xs-12">
                    ...
                    @if(isset($featured_latest) && count($featured_latest)>0))
                    <div class="best_prod_lsiting middle_product best-product-video">
                        <video width="100%" height="100%" controls>
                            <source @if(isset($featured_latest->productDescription->video)) src ="{{ url('storage/app/public/product/video').'/'.$featured_latest->productDescription->video }}" @else src="public/media/front/video/video3.mp4" @endif type="video/mp4">
...
{{--</section> -->--}}
{{--<!-------------------------------------------OUR PROFESSIONAL & ARTISTS APPOINMENT------------------------>--}}
<section class="our_story" style="background-image:url('{{ url('/public/media/front/img/bg-privacy-policy1.jpg') }}')">
    <div class="container">
        <div class="main_heading"><span>OUR STORY</span></div>
        <div class="heading_description">
            Accumulation of Incredible Memories, Inspirations behind our Products, Customers Experiences &  Stories  all captured , collected  and presented beautifully in a place where everyone of us can connect and share with all . Come and be a part of our family and in our Journey
            ...
            <div class="row">
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="conversion_video">
                        ...
                        <a style="cursor:pointer;text-decoration: none" onclick="openInNewTab('{{ GlobalValues::get("facebook-link") }}')">
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="conversion_video">
                        <div class="video_blk">
                            <a style="cursor:pointer;text-decoration: none" onclick="openInNewTab('{{ GlobalValues::get("instagram-link") }}')">
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="conversion_video">
                        <div class="video_blk">
                            <a style="cursor:pointer;text-decoration: none" onclick="openInNewTab('{{ GlobalValues::get("pinterest-link") }}')">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="video_section">
            <video width="400" controls>
                <source @if(isset($gallery) && $gallery->path !='') src="{{ url('storage/app/public/gallery/videos').'/'.$gallery->path }}" @endif type="video/mp4">
            </video>
        </div>
      </div>      
    </div>
