                                    ...
                                    <div class="carousel-inner">
                                        ...
                                        @if(isset($ajaxProduct[0]['product_images']))
                                            @foreach($ajaxProduct[0]['product_images'] as $c)
                                                @if(!empty($c->images))
                                        <div @if(!empty($c->images)) id="dv-car-col-img-id-{{ trim($c->images) }}" @endif class="item car-col-img-dv">
                    ...
                    <div class="col-md-7"><br>
                        <div class="h-product-details">
                            ...
                            @if($ajaxProduct[0]['is_original'] == 1)
                              ...
                              <input type="hidden" id="price" value="{{ $ajaxProduct[0]['discount_rate'] }}">
                            ...
                            @if(!empty($ajaxProduct[0]['product_images']) || !empty($ajaxProduct[0]['product_color']))
                            ...
                            @if(isset($ajaxProduct['attribute_name']) && count($ajaxProduct['attribute_name'])>0)
                                ...
                                <div class="size-optn font-2">
                                    ...
                                    <label> <span style="display: none" id="spn-size-lbl" class="option"> SIZE OPTIONS </span> </label>
                            ...
                            <div class="h-product-buttons quick-view-counter clearfix">
                                ...
                                <div class="h-add-cart">
                                        ...
                                        <button id="add-in-cart" class="add-cart" type="submit"><i class="fa fa-shopping-bag"></i></button>
                                         @endif
                                         @if(Auth::check())                                          
                                             <button id="add-wishlist-{{ $ajaxProduct[0]['id'] }}" data-toggle="modal" onclick="addToWishlist('{{ $ajaxProduct[0]['id'] }}')" type="button" class="add-cart-data"><i
                                             class="fa fa-heart"></i>
                                             </button>
                                         @endif
                                    @endif
...
//        alert($('#'+id).attr('title'));
        ...
        // $('.pro-color-apply').each(function(){
        //     $(this).removeClass('pro-color-bg');
        // });
