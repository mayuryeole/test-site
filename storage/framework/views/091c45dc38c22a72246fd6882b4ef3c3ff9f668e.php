                        ...
                        <div class="col-md-8">  
                         <div class="form-group">
                          <label class="col-md-6 control-label">Name<sup>*</sup></label>
                            ...
                            <div class="col-md-6">     
                             <input name="name" type="text" class="form-control"  id="name" value="<?php echo e(old('name',$state_info->name)); ?>">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input name="iso" type="text" class="form-control"  id="iso" value="<?php echo e(old('iso',$state_info->iso_code)); ?>">
                          ...
                          <label class="col-md-6 control-label">Select Country<sup>*</sup></label>
                           ...
                           <select name="country" id="country" class="form-control">
                            ...
                            <option value="<?php echo e($country->id); ?>" <?php if(old('country',$state->country_id)==$country->id): ?> selected <?php endif; ?>><?php echo e($country->name); ?></option>
                            <?php endforeach; ?>
                            </select>
