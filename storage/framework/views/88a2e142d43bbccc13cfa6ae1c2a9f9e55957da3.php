    	...
    	<table class="table" width="100%" cellspacing="0">
        	<tr>
            	<td style="padding:5px 10px; height:50px; border-bottom:1px solid #e5e5e5;">
                    <img src="<?php echo e(url('public/media/front/img/logo.png')); ?>" alt="logo" width="150px" style="position: absolute;left: 0px;right: 0px;margin: 0px auto;top: 70px;" >
                </td>
                <td style="padding:5px 10px; height:50px; border-bottom:1px solid #e5e5e5;">
                	...
                	<div class="feedback">
                        ...
                        <div class="feedback-cust" style=" position: relative;top: 0px;">
                        	<p style=" line-height: 24px;color: #333;position: relative; top: -30px;text-align:center;">
                            	<span class="dear" style="font-weight:bold;">Hello <?php echo e($FIRST_NAME); ?>,</span>
 				Please find below your booking details,<br />
    
				Booking Id - <?php echo e($APPOINTMENT_ID); ?> <br />

				Counselor - <?php echo e($COUNSELOR_NAME); ?> <br />

				Date - <?php echo e($APPOINTMENT_DATE); ?><br />

				Time slot- <?php echo e($TIME_SLOT); ?><br />
