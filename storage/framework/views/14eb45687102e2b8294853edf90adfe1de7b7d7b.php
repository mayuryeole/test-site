    ...
    <div class="page-content">
        ...
        <div class="portlet box blue">
            ...
            <div class="portlet-body form">
                <form class="form-horizontal" name="update_paper" id="update_paper" role="form" action="<?php echo e(url('/admin/update-paper/').'/'.$paper_details->id); ?>" method="post" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                            ...
                            <div class="col-md-12">    
                                <div class="col-md-8">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" class="form-control" name="paper_name" id="paper-name" value="<?php echo e($paper_details->name); ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="hidden" name="old_image" value="<?php echo e($paper_details->image); ?>">
                                            <image id="show_image" <?php if(!empty($paper_details->image)): ?> src="<?php echo e(url("storage/app/public/paper_image/").'/'.$paper_details->image); ?>" <?php else: ?> style="display: none" <?php endif; ?> style="margin-top: 10px" class="paper-image" height="50px" width="50px">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">     
                                            <select name="status" class="form-control" id="status" onchange="hideShowTextbox(this)">
                                                ...
                                                <option <?php if($paper_details->status==0): ?> selected <?php endif; ?> value="0">Free</option>
                                                <option <?php if($paper_details->status==1): ?> selected <?php endif; ?> value="1">Paid</option>
                                            </select>
                                    ...
                                    <div class="form-group" id="order_quantity_div" <?php if($paper_details->status!=1): ?> style="display:none" <?php endif; ?>>
                                        <label class="col-md-6 control-label">Price<sup>*</sup></label>

                                        <div class="col-md-6">
                                            <input name="price" type="text" class="form-control" onkeyup="callToDiscount()" id="price" value="<?php echo e($paper_details->price); ?>">
                                    ...
                                    <div class="form-group <?php if($errors->has('description')): ?> has-error <?php endif; ?>">
                                        ...
                                        <div class="col-md-6">
                                            <textarea name="description" type="text" class="form-control" id="description"><?php echo e($paper_details->description); ?></textarea>
                                    ...
                                    <?php /*<div class="form-group" id="order_quantity_div" style="display:none">*/ ?>
                                        ...
                                        <?php /*<div class="col-md-6">     */ ?>
                                            <?php /*<input name="order_quantity" id="order_quantity" type="text" class="form-control" value="<?php echo e($paper_details->order_quantity); ?>">*/ ?>
