    ...
    <div class="page-content">
        ...
        <div class="portlet box blue">
            ...
            <div class="portlet-body form">
                <form class="form-horizontal" name="create_display" id="create_display" role="form" action="<?php echo e(url('/admin/display/create' )); ?>" method="post" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                            ...
                            <div class="col-md-12">    
                                <div class="col-md-8">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" class="form-control" name="display_name" id="display-name" value="<?php echo e(old('display_name')); ?>">
