...
<div class="page-content-wrapper">
    <div class="page-content">
        ...
        <?php if(session('already-exist')): ?>
        <div class="alert alert-success">
            <?php echo e(session('already-exist')); ?>
                    ...
                    <div class="portlet-body">
                        <div class="table-toolbar">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="btn-group">
                                        <a href="<?php echo e(url('/admin/category/create_subsubcategories')); ?>/<?php echo e($cat_id); ?>" id="sample_editable_1_new" class="btn green">
    ...
    <script>
                ...
                processing: true,
                        serverSide: true,
                        //bStateSave: true,
                        ajax: {"url":'<?php echo e(url("/admin/subsubcategories-list-data/$cat_id")); ?>', "complete":afterRequestComplete},
                        columnDefs: [{
                        "defaultContent": "-",
                                "targets": "_all",
                        }],
...
//                                if (type === 'display') {
//
//                                return '<a  class="btn btn-sm btn-primary" href="<?php echo e(url("/admin/category")); ?>/' + row.id + '">Sub-sub category</a>';
//                                }
//                                return data;
//                                },
//                                "orderable": false,
...
//                        },
                        {data:   "Update",
                                ...
                                if (type === 'display') {
                                   ...
                                   str="";
                                str='<a  class="btn btn-sm btn-primary" href="<?php echo e(url("/admin/subsubcategory")); ?>/' + row.id + '">Update</a>';
