...
<!--                                    <th>
                        ...
                        <!--<input type="button" onclick='javascript:deleteAll("<?php echo e(url('/admin/delete-product-selected-attributes-value')); ?>")' name="delete" id="delete" value="Delete Selected" class="btn btn-danger">-->  
                    </div>
                </div>
...
//                    serverSide: true,
                    ordering:false,
                    //bStateSave: true,
                    ajax: {"url":'<?php echo e(url("/admin/manage-product/attributes-data")); ?>/<?php echo e($product_id); ?>', "complete":afterRequestComplete},
                    columnDefs: [{
                    "defaultContent": "-",
                            "targets": "_all",
                    }],
...
//                    },
                    ...
                    {data:   "Update",
                            ...
                            return '<a  class="btn btn-sm btn-primary" href="<?php echo e(url("/admin/manage-product/attributes-value")); ?>/'+ <?php echo e($product_id); ?> + '/' + row.attribute_id +'">Update</a>';
                            }
                            return data;
                            },
                            "orderable": false,
...
//                            if (type === 'display') {
//
//                            return '<form id="product_delete_' + row.id + '"  method="post" action="<?php echo e(url("/admin/delete-product-attributes-value")); ?>/' + row.id + '"><?php echo e(method_field("DELETE")); ?> <?php echo csrf_field(); ?><button onclick="confirmDelete(' + row.id + ');" class="btn btn-sm btn-danger" type="button">Delete</button></form>';
//                            }
//                            return data;
//                            },
//                            "orderable": false,
