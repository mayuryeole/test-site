                	...
                	<div class="feedback">
                        ...
                        <div class="feedback-cust" style=" position: relative;top: 0px;">
                        	<p style=" line-height: 24px;color: #333;position: relative; top: -30px;text-align:center;">
                            	<span class="dear" style="font-weight:bold;">Hello <?php echo e($FIRST_NAME); ?> <?php echo e($LAST_NAME); ?>,</span>
 				Your appointment is rejected by your counselor  <?php echo e($COUNSELOR_NAME); ?>,<br />
