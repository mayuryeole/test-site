...
<?php $__env->startSection('content'); ?>
    <section class="h-inner-banner" style="background-image:url(<?php echo e(url("/public/media/front/img/cart-bg.jpg")); ?>);">
    ...
    <section class="h-add-cart-page">
        <div class="container-fluid">
            <?php 
                $ctryDetls = null;
             ?>
            <?php if(session('cart-err')): ?>
                <div class="alert alert-danger">
                    <?php echo e(session('cart-err')); ?>

                    <a href="#" class="close" data-dismiss="alert" aria-label="close" title="close">×</a>
                </div>
            <?php endif; ?>
            <?php if(isset($cart->cartItems) && count($cart->cartItems)>0): ?>
                <div class="row">
                    ...
                    <form id="proceed-to-checkout-form" action="" method="post" class="add-ct-form">
                        ...
                        <div class="col-md-8 col-sm-8 col-xs-12">
                            <div class="cart-table table-responsive">
                                <table>
                                    ...
                                    <input type="hidden" id="cart-id" name="cart_id" value="<?php echo e($cart->id); ?>">
                                    <?php foreach($cart->cartItems as $cart_item): ?>
                                        <?php 
                                            $product = \App\PiplModules\product\Models\Product::where('id',$cart_item->product_id)->first();
                                         ?>
                                        <?php if(isset($product) && count($product) > 0): ?>
                                            <input id="max-order-qty_<?php echo e($cart_item->id); ?>" type="hidden"
                                                   <?php if(isset($product) && $product->productDescription->max_order_qty != ""): ?> value="<?php echo e($product->productDescription->max_order_qty); ?>" <?php endif; ?>>
                                            <input id="max-qty_<?php echo e($cart_item->id); ?>" type="hidden"
                                                   <?php if(isset($product) && $product->productDescription->quantity != ""): ?> value="<?php echo e($product->productDescription->quantity); ?>" <?php endif; ?>>

                                            <tr id="<?php echo e($cart_item->id); ?>">
                                                <td class="pro-thumbnail pro-remove">
                                                    <a href="<?php echo e(url('product').'/'.$cart_item->product->id); ?>">
                                                        <img src="<?php echo e(url('/storage/app/public/product/image/'.$cart_item->product->productDescription->image)); ?>"
                                                             alt="product image"/>
                                                    </a>
                                                    <span class="span-block">
                                                        <button type="button" data-toggle="modal"
                                                                onclick="showQuickView('<?php echo e($cart_item->product_id); ?>')"><i
                                                                    class="fa fa-edit"></i> Edit</button>
                                                        <button type="button" href="#"
                                                                id="rm-cart-tem_<?php echo e($cart_item->id); ?>"
                                                                onclick="removeCartItem(this.id)"><i
                                                                    class="fa fa-trash"></i> Remove</button>
                                                    </span>
                                                </td>
                                                <td class="pro-title">
                                                    <a href="<?php echo e(url('product').'/'.$cart_item->product->id); ?>"><?php echo e($cart_item->product->name); ?></a>
                                                    <div class="product-id">
                                                        <span>Product Id : <?php echo e($cart_item->product->productDescription->sku); ?></span>
                                                    </div>
                                                    <div id="dv-prod-clr-<?php echo e($cart_item->id); ?>" class="h-color">
                                                        <span>Color : <?php if(!empty($cart_item->product_color_name)): ?> <?php echo e($cart_item->product_color_name); ?>   <?php endif; ?>  </span>
                                                    </div>
                                                    <div id="dv-prod-siz-<?php echo e($cart_item->id); ?>" class="h-size">
                                                        <span>Size : <?php if(!empty($cart_item->product_size_name)): ?> <?php echo e($cart_item->product_size_name); ?>  <?php endif; ?></span>
                                                    </div>
                                                    <span class="span-block">
                                                    <div style="display:none;color:orange"
                                                         id="err-dv-prod-id-<?php echo e($cart_item->id); ?>"></div>
                                                    </span>
                                                    <script>
                                                ...
                                                <td class="pro-price"><span
                                                            class="amount"><?php echo e(\App\Helpers\Helper::getCurrencySymbol().number_format(\App\Helpers\Helper::getRealPrice($cart_item->product_amount),2,'.','')); ?></span>
                                                </td>
                                                <?php if(Auth::check()): ?>
                                                    <td class="pro-wishlist">
                                                        <button onclick="moveToWishlist('<?php echo e($cart_item->id); ?>')"
                                                ...
                                                <td class="pro-quantity">
                                                    <div class="h-quantity">
                                                        <button id="minus-cnt-btn_<?php echo e($cart_item->id); ?>" type="button"
                                                                onclick="addRemoveProductQuantity(this.id,'min')"
                                                                class="h-minus-pro"><i class="icon-substract"></i>
                                                        </button>
                                                        <input id="show-product-count_<?php echo e($cart_item->id); ?>"
                                                               name="product_qty" type="text" class="form-control"
                                                               <?php if(isset($cart_item) && $cart_item->product_quantity !=0): ?>value="<?php echo e($cart_item->product_quantity); ?>"
                                                               <?php endif; ?> disabled/>
                                                        <button id="add-cnt-btn_<?php echo e($cart_item->id); ?>" type="button"
                                                                onclick="addRemoveProductQuantity(this.id,'add')"
                                                                class="h-plus-pro"><i class="icon-add"></i></button>
                                                    </div>
                                                    <div style="display: none;color: red"
                                                         id="add-minus-status_<?php echo e($cart_item->id); ?>">
                                                    </div>
                                                </td>
                                                <input type="hidden" id="one-qty-price_<?php echo e($cart_item->id); ?>"
                                                       value="<?php echo e($cart_item->product_amount); ?>">
                                                <td class="pro-subtotal"><p id="subtotal_<?php echo e($cart_item->id); ?>">
                                                        <?php echo e(\App\Helpers\Helper::getCurrencySymbol().number_format(\App\Helpers\Helper::getRealPrice($cart_item->product_amount * $cart_item->product_quantity),2,'.','')); ?></p>
                                                </td>
                                                <script>
                                                ...
                                                <?php /*<!--<td class="pro-remove"><button type="button" data-toggle="modal" onclick="showQuickView('<?php echo e($cart_item->product_id); ?>')"><i class="fa fa-edit"></i> Edit</button><button type="button" href="#" id="rm-cart-tem_<?php echo e($cart_item->id); ?>" onclick="removeCartItem(this.id)"><i class="fa fa-trash"></i> Remove</button></td>-->*/ ?>
                                            </tr>
                            ...
                            <div class="h-cust-details-info">
                                <form>
                                    ...
                                    <input id="ip-token" type="hidden" value="<?php echo e(csrf_token()); ?>">
                                    <div class="card-details clearfix">
                                        ...
                                        <div class="sender-receiver-details">
                                                ...
                                                <div class="adderss_wrapper clearfix">
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="inner-address">
                                                            <?php if(\Auth::check()): ?>
                                                                <p class="buyer_name"><?php if(\Auth::check()): ?><?php echo e(\Auth::user()->userInformation->first_name.' '.\Auth::user()->userInformation->last_name); ?> <?php endif; ?></p>
                                                                <p class="buyer_city"><?php if(\Auth::check()): ?><?php echo e(\Auth::user()->userInformation->city); ?> <?php endif; ?></p>
                                                                <?php /*<p class="buyer_country"><?php if(\Auth::check()): ?><?php echo e(\Auth::user()->userAddress['user_country']); ?> <?php endif; ?></p>*/ ?>
                                                                <p class="buyer_phone"><?php if(\Auth::check() && !empty(\Auth::user()->userInformation->user_mobile) ): ?>Mobile
                                                                    Number:<?php echo e(\Auth::user()->userInformation->user_mobile); ?> <?php endif; ?></p>
                                                            <?php else: ?>
                                                                <p class="buyer_name">You are not login yet! Please <a
                                                                            href="<?php echo e(url('login')); ?>" target="new">click
                                                                        here</a> to login</p>
                                                            <?php endif; ?>
                                                        </div>
                                                        <?php if(\Auth::check()): ?>
                                                        ...
                                                        <div class="inner-address">
                                                            <?php if($cart->shipping_name): ?>
                                                                <?php 
                                                                 ...
                                                                 ?>
                                                                <p class="buyer_name"><?php echo e($cart->shipping_name); ?></p>
                                                                <p class="buyer_addrss"><?php echo e($cart->shipping_address1); ?>

                                                                    , <?php echo e($cart->shipping_address2); ?> </p>
                                                                <p class="buyer_city"><?php echo e($city_name); ?>

                                                                    , <?php echo e($state_name); ?> <?php echo e($cart->shipping_zip); ?></p>
                                                                <p class="buyer_country"><?php echo e($country_name); ?></p>
                                                                <p class="buyer_phone">Phone
                                                                    Number: <?php echo e($cart->shipping_telephone); ?></p>
                                                            ...
                                                            <ul class="pay-method">
                                                                <li class="h-cust-radio">
                                                                    <label class="mode">
                                                                        ...
                                                                        <?php /*<img src="<?php echo e(url('/public/media/front/img/visa.png')); ?>">*/ ?>
                                                                        Online Payment
                                                                    </label>
                                                                </li>
                                                                <li class="h-cust-radio">
                                            ...
                                            <?php /*<table>*/ ?>
                                            <?php /*<tr>*/ ?>
                                            <?php /*<td class="notop-border notop-padding" colspan="2">*/ ?>
                                            <?php /*<a class="apply-coupon-code" href="javascript:void(0)" id="add_coupon">+ Apply Coupon Code</a>*/ ?>
                                            <?php /*</td>*/ ?>
                                            <?php /*</tr>*/ ?>
                                            <?php /*<tr id="enter_coupon" style="display: none">*/ ?>
                                            <?php /*<td class="notop-border notop-padding" colspan="2">*/ ?>
                                            <?php /*<form class="coupon-code-form">*/ ?>
                                            <?php /*<input class="form-control input-sm" type="text" placeholder="Enter Coupon Code" id="coupon_code" <?php if(isset($cart)): ?> rel="<?php echo e($cart->id); ?>" <?php endif; ?>>*/ ?>
                                            <?php /*<input type="button" class="btn btn-sm btn-w-b" value="Apply" id="apply_coupon" onclick="addCoupon()">*/ ?>
                                            <?php /*<span class="text-danger" style="display: none" id="coupon_invalid">Invalid Coupon Code</span>*/ ?>
                                            <?php /*</form>*/ ?>
                                            <?php /*</td>*/ ?>
                                            <?php /*</tr>*/ ?>
                                            <?php /*<tr>*/ ?>
                                            <?php /*<td class="notop-border notop-padding" colspan="2">*/ ?>
                                            <?php /*<a class="apply-coupon-code" href="javascript:void(0)" id="add_promo_code">+ Apply Promo Code</a>*/ ?>
                                            <?php /*</td>*/ ?>
                                            <?php /*</tr>*/ ?>
                                            <?php /*<tr id="enter_promo_code" style="display: none">*/ ?>
                                            <?php /*<td class="notop-border notop-padding" colspan="2">*/ ?>
                                            <?php /*<form class="coupon-code-form">*/ ?>
                                            <?php /*<input class="form-control input-sm" type="text" placeholder="Enter Promo Code" id="promo_code" <?php if(isset($cart)): ?> rel="<?php echo e($cart->id); ?>" <?php endif; ?>>*/ ?>
                                            <?php /*<input type="button" class="btn btn-sm btn-w-b" value="Apply" id="apply_promo_code" onclick="addPromoCode()">*/ ?>
                                            <?php /*<span class="text-danger" style="display: none" id="promo_invalid">Invalid Coupon Code</span>*/ ?>
                                            <?php /*</form>*/ ?>
                                            <?php /*</td>*/ ?>
                                            <?php /*</tr>*/ ?>
                                            ...
                                            <?php /*<tr>*/ ?>
                                            <?php /*<td>Total</td>*/ ?>
                                            <?php /*<td class="ar"><strong><span id="sub_total"><?php if(isset($cart)): ?> <?php echo e($totalAmount); ?> <?php else: ?> 0 <?php endif; ?></span></strong></td>*/ ?>
                                            <?php /*</tr>*/ ?>
                                            <?php /*<tr>*/ ?>
                                            <?php /*<td>Coupon Amount</td>*/ ?>
                                            <?php /*<td class="ar"><strong><span id="coupon_total"><?php if(isset($cart) && (isset($totalMinusCoupon) && $totalMinusCoupon!= 0)): ?> <?php echo e($totalAmount-$totalMinusCoupon); ?> <?php else: ?> 0 <?php endif; ?></span></strong></td>*/ ?>
                                            <?php /*</tr>*/ ?>
                                            <?php /*<tr>*/ ?>
                                            <?php /*<td>Grand Total</td>*/ ?>
                                            <?php /*<td class="ar"><strong><span id="grand_total"><?php if(isset($cart) && (isset($totalMinusCoupon) &&  $totalMinusCoupon!=0)): ?> <?php echo e($totalMinusCoupon); ?> <?php else: ?> <?php echo e($totalAmount); ?> <?php endif; ?></span></strong></td>*/ ?>
                                            <?php /*</tr>*/ ?>

                                            <?php /*</table>*/ ?>
                                            <?php /*</div>*/ ?>
                                            <?php /*<?php if(isset($cart) && $cart->shipping_name !=''): ?>*/ ?>
                                            <?php /*<div class="row">*/ ?>
                                            <?php /*<div class="h-btn-blk text-center">*/ ?>
                                            <?php /*<input id="<?php echo e($cart->id); ?>" style="align-content: center" onclick="checkOut(this.id)" class="h-update-cart center-button" type="button" value="Checkout">*/ ?>
                                            <?php /*</div>*/ ?>
                                            <?php /*</div>*/ ?>
                                            <?php /*<?php endif; ?>*/ ?>
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12">
                            <div class="cart-right-panel">
                                                            ...
                                                            <div class="locator-form text-center clearfix">
                                                                    ...
                                                                    <select name="dom_country_zip" id="dom-country-zip"
                                                                        ...
                                                                        <?php if(isset($all_countries)): ?>
                                                                            ...
                                                                            <?php foreach($all_countries as $country): ?>
                                                                                <?php if(!empty($country->name) && $country->name=="India"): ?>
                                                                                    <option class="select-option"
                                                                                            name="dom_country_zip"
                                                                                            label="<?php echo e($country->name); ?>"
                                                                                            <?php if((isset($cart) && !empty($cart)) && $cart->shipping_country == $country->name): ?> selected
                                                                ...
                                                                <div class="harsh-btn-blk relative">
                                                                    ...
                                                                    <div id="dv-loader-national" style="display: none"
                                                                        ...
                                                                        <img src="<?php echo e(url('public/media/front/img/25.gif')); ?>">
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <input type="hidden" id="chk-service-session"
                                                                       <?php if(Session::has('service_details') && Session::get('service_details.service_name')!='' && Session::get('service_details.service_price')!=0): ?> value="1"
                                                                       <?php else: ?> value="0" <?php endif; ?>>
                                                                <input type="hidden" id="hid-session-price"
                                                                       <?php if(Session::has('service_details') && Session::get('service_details.service_name')!='' && Session::get('service_details.service_price')!=0): ?> value="<?php echo e(Session::get('service_details.service_price')); ?>"
                                                                       <?php else: ?> value="0" <?php endif; ?>>
                                                                            ...
                                                                            <?php foreach($all_countries as $country): ?>
                                                                                <?php if(!empty($country->name) && $country->name !="India"): ?>
                                                                                    <option class="select-option"
                                                                                            name="inter_country_zip"
                                                                                            label="<?php echo e($country->name); ?>"
                                                                                            <?php if((isset($cart) && $cart!="") && $cart->shipping_country == $country->name): ?> selected
                                                                                            <?php endif; ?> value=<?php echo e($country->id); ?>><?php echo e($country->name); ?></option>
                                                                                <?php endif; ?>
                                                                                <?php /*<option class="select-option" label="India" <?php if(isset($cart) && $cart->shipping_country == 'India'): ?> selected <?php endif; ?> value="India">India</option>*/ ?>
                                                                                <?php /*<option class="select-option" label="United States" <?php if(isset($cart) && $cart->shipping_country == 'United States'): ?> selected <?php endif; ?> value="United States">United States</option>*/ ?>
                                                                            <?php endforeach; ?>
                                                                        <?php endif; ?>
                                                                    </select>
                                                                </div>
                                ...
                                <?php /*<div class="panel-heading" role="tab">*/ ?>
                                <?php /*<a role="button" data-toggle="collapse" data-parent="#accordion"*/ ?>
                                <?php /*href="#estimate-ship-tax" class="relative">*/ ?>
                                <?php /*DHL Pincode / Zipcode Check*/ ?>
                                <?php /*<span drop-icon><i class="fa fa-angle-down"></i></span>*/ ?>
                                <?php /*</a>*/ ?>
                                <?php /*</div>*/ ?>
                                <?php /*<div id="estimate-ship-tax" class="panel-collapse collapse">*/ ?>
                                <?php /*<div class="panel-body">*/ ?>
                                <?php /*<div class="cart-location">*/ ?>
                                <?php /*<!-- Tab panes -->*/ ?>
                                <?php /*<div class="tab-content">*/ ?>
                                <?php /*<div role="tabpanel" class="tab-pane active" id="home">*/ ?>
                                <?php /*<div class="locator-form text-center clearfix">*/ ?>
                                <?php /*<div class="check-country">*/ ?>
                                <?php /*<select class="form-control">*/ ?>
                                <?php /*<option>Select Country</option>*/ ?>
                                <?php /*<option>India</option>*/ ?>
                                <?php /*<option>USA</option>*/ ?>
                                <?php /*<option>Canada</option>*/ ?>
                                <?php /*<option>UK</option>*/ ?>
                                <?php /*<option>Japan</option>*/ ?>
                                <?php /*</select>*/ ?>
                                <?php /*</div>*/ ?>
                                <?php /*<div class="check-country">*/ ?>
                                <?php /*<select class="form-control">*/ ?>
                                <?php /*<option>Select State / Province</option>*/ ?>
                                <?php /*<option>Pune</option>*/ ?>
                                <?php /*<option>Mumbai</option>*/ ?>
                                <?php /*<option>Chenai</option>*/ ?>
                                <?php /*</select>*/ ?>
                                <?php /*</div>*/ ?>
                                <?php /*<div class="check-country">*/ ?>
                                <?php /*<input class="form-control" placeholder="city"/>*/ ?>
                                <?php /*</div>*/ ?>
                                <?php /*<div class="check-country">*/ ?>
                                <?php /*<input class="form-control" placeholder="zip"/>*/ ?>
                                <?php /*</div>*/ ?>
                                <?php /*<a href="javascript:void(0);"*/ ?>
                                <?php /*class="check-btn">Estimate</a>*/ ?>
                                <?php /*</div>*/ ?>
                                <?php /*</div>*/ ?>
                                <?php /*</div>*/ ?>
                                <?php /*</div>*/ ?>
                                                            ...
                                                            <div class="locator-form text-center clearfix">
                                                                <div class="promo-code-btn relative">
                                                                    <input id="ip-coupon-code" type="text"
                                                                           name="coupon_code"
                                                                           <?php if(isset($cart)): ?> rel="<?php echo e($cart->id); ?>"
                                                                           <?php endif; ?> <?php if(Session::has('all_cart_data') && Session::get('all_cart_data.coupon_code')!=''): ?> value="<?php echo e(Session::get('all_cart_data.coupon_code')); ?>" <?php endif; ?> class="form-control" placeholder=""/>
                                                                    <div class="promo-btn"><a id="ancr-coupon-code"
                                                                                              href="javascript:void(0);"
                                                                                              onclick="doCoupon(this.id)">
                                                                            <?php if(Session::has('all_cart_data') && Session::get('all_cart_data.coupon_code')!=''): ?> value="<?php echo e(Session::get('all_cart_data.coupon_code')); ?>" Remove Coupon <?php else: ?> Apply Code <?php endif; ?></a></div>
                                                                    <p id="coupon-span"
                                                            ...
                                                            <div class="locator-form text-center clearfix">
                                                                <div class="promo-code-btn relative">
                                                                    <input id="ip-promo-code" name="promo_code"
                                                                           type="text"
                                                                           <?php if(isset($cart)): ?> rel="<?php echo e($cart->id); ?>"
                                                                           <?php endif; ?> <?php if(Session::has('all_cart_data') && Session::get('all_cart_data.promo_code')!=''): ?> value="<?php echo e(Session::get('all_cart_data.promo_code')); ?>" <?php endif; ?>  class="form-control" placeholder=""/>
                                                                    <div class="promo-btn"><a id="ancr-promo-code"
                                                                                              href="javascript:void(0);"
                                                                                              onclick="doPromoCode(this.id)">
                                                                            <?php if(Session::has('all_cart_data') && Session::get('all_cart_data.promo_code')!=''): ?> Remove Promo <?php else: ?> Apply Code <?php endif; ?> </a></div>
                                                                    <p class="text-danger"
                                                ...
                                                <div class="cart-location">
                                                    ...
                                                    <div class="tab-content">
                                                        <div role="tabpanel" class="tab-pane active" id="home">
                                                            <div class="locator-form text-center clearfix">
                                                                <div class="promo-code-btn relative">
                                                                    <?php /*<input type="text" class="form-control" placeholder=""/>*/ ?>
                                                                    <?php /*<div class="promo-btn"><a href="javascript:void(0);">Apply Code</a></div>*/ ?>
                                                                    <input id="ip-gift-code" name="gift_code"
                                                                           <?php if(isset($cart)): ?> rel="<?php echo e($cart->id); ?>"
                                                                           <?php endif; ?> <?php if(Session::has('all_cart_data') && Session::get('all_cart_data.gift_voucher') !=0): ?> <?php endif; ?> type="text" class="form-control"
                                                                           placeholder=""/>
                                                                    <div class="promo-btn"><a id="ancr-gift-code"
                                                                                              href="javascript:void(0);"
                                                                                              onclick="doGiftCode(this.id)">
                                                                            <?php if(Session::has('all_cart_data') && Session::get('all_cart_data.gift_voucher') !=0): ?> Remove Gift Voucher  <?php else: ?> Apply Code <?php endif; ?>  </a></div>
                                                                    <p class="text-danger"
                                                                       style="text-align:left;padding-left:5px;font-size: 14px;margin-bottom:5px;color:orange;display:none"
                                                            ...
                                                            <div class="locator-form text-center clearfix">
                                                                <ul class="invoice-list">
                                                                    <li class="clearfix">
                                                                       ...
                                                                       <?php if(count($arrCartData)>0 && $arrCartData['total'] !=''): ?> <?php echo e(\App\Helpers\Helper::getCurrencySymbol().number_format(\App\Helpers\Helper::getRealPrice($arrCartData['total']),2,'.','')); ?> <?php else: ?> <?php echo e(\App\Helpers\Helper::getCurrencySymbol().'0.00'); ?> <?php endif; ?>
                                                                </span>
                                                                    </li>
                                                                    <li class="clearfix">
                                                                        ...
                                                                        <span id="shipping-total"
                                                                              class="inv-left-list inv-right">
                                                                   <?php if(count($arrCartData)>0 && $arrCartData['shipping_charge'] !=''): ?> <?php echo e(\App\Helpers\Helper::getCurrencySymbol().number_format(\App\Helpers\Helper::getRealPrice($arrCartData['shipping_charge']),2,'.','')); ?> <?php else: ?> <?php echo e(\App\Helpers\Helper::getCurrencySymbol().'0.00'); ?> <?php endif; ?>
                                                                </span>
                                                                    </li>
                                                                    <li class="clearfix">
                                                                        ...
                                                                        <span id="coupon-amt"
                                                                              class="inv-left-list inv-right">
                                                                    <?php echo e(\App\Helpers\Helper::getCurrencySymbol().number_format(\App\Helpers\Helper::getRealPrice(Session::get('all_cart_data.coupon_amount')),2,'.','')); ?>
                                                                    ...
                                                                    <li class="clearfix">
                                                                        ...
                                                                        <span id="promo-total"
                                                                              class="inv-left-list inv-right">
                                                                    <?php echo e(\App\Helpers\Helper::getCurrencySymbol().number_format(\App\Helpers\Helper::getRealPrice(Session::get('all_cart_data.promo_amount')),2,'.','')); ?>
                                                                    ...
                                                                    <li class="clearfix">
                                                                        ...
                                                                        <span id="gift-voucher-total"
                                                                              class="inv-left-list inv-right">
                                                                    <?php echo e(\App\Helpers\Helper::getCurrencySymbol().number_format(\App\Helpers\Helper::getRealPrice(Session::get('all_cart_data.gift_voucher')),2,'.','')); ?>

                                                                </span>
                                                                    </li>
                                                                    <?php /*<li class="clearfix">*/ ?>
                                                                        <?php /*<span class="inv-left-list inv-left">REFFER POINTS AMOUNT</span>*/ ?>
                                                                        <?php /*<span id="refer-total"*/ ?>
                                                                              <?php /*class="inv-left-list inv-right">*/ ?>
                                                                    <?php /*<?php echo e(\App\Helpers\Helper::getCurrencySymbol().number_format(\App\Helpers\Helper::getRealPrice(Session::get('all_cart_data.refer_points')),2,'.','')); ?>*/ ?>
                                                                <?php /*</span>*/ ?>
                                                                    <?php /*</li>*/ ?>
                                                                    <li class="clearfix">
                                                                        ...
                                                                        <span id="pakaging-total"
                                                                              class="inv-left-list inv-right">
                                                                 <?php if(count($arrCartData)>0): ?><?php echo e(\App\Helpers\Helper::getCurrencySymbol().number_format(\App\Helpers\Helper::getRealPrice($arrCartData['box_amount'] + $arrCartData['paper_amount']),2,'.','')); ?> <?php else: ?>
                                                                                <?php echo e(\App\Helpers\Helper::getCurrencySymbol().'0.00'); ?> <?php endif; ?>
                                                                </span>
                                                                    </li>
                                                                    <li class="clearfix">
                                                                        ...
                                                                        <span id="display-total"
                                                                              class="inv-left-list inv-right">
                                                                   <?php if(count($arrCartData)>0 && $arrCartData['display_amount'] !=''): ?> <?php echo e(\App\Helpers\Helper::getCurrencySymbol().number_format(\App\Helpers\Helper::getRealPrice($arrCartData['display_amount']),2,'.','')); ?> <?php else: ?> <?php echo e(\App\Helpers\Helper::getCurrencySymbol().'0.00'); ?> <?php endif; ?>
                                                               </span>
                                                                    </li>
                                                                    <li class="clearfix">
                                                                        ...
                                                                        <span id="tax-total"
                                                                              class="inv-left-list inv-right">
                                                                    <?php if($cart->tax !=0): ?><?php echo e(\App\Helpers\Helper::getCurrencySymbol().number_format(\App\Helpers\Helper::getRealPrice($cart->display_amount),2,'.','')); ?> <?php else: ?>
                                                                                <?php echo e(\App\Helpers\Helper::getCurrencySymbol().'0.00'); ?> <?php endif; ?>
                                                                </span>
                                                                    </li>
                                                                    <li class="clearfix">
                                                                        ...
                                                                        <span id="total-savings"
                                                                              class="inv-left-list inv-right">
                                                                    <?php echo e(\App\Helpers\Helper::getCurrencySymbol().number_format(\App\Helpers\Helper::getRealPrice(Session::get('all_cart_data.total_savings')),2,'.','')); ?>
                                                                    ...
                                                                    <li class="clearfix">
                                                                      ...
                                                                      <?php if(count($arrCartData)>0): ?> <?php echo e(\App\Helpers\Helper::getCurrencySymbol().number_format(\App\Helpers\Helper::getRealPrice($arrCartData['grand_total']),2,'.','')); ?> <?php else: ?> <?php echo e(\App\Helpers\Helper::getCurrencySymbol().'0.00'); ?> <?php endif; ?>
                                                                </span>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                ...
                                <div class="row clearfix">
                                    <div class="col-md-12">
                                        <form id="chek-out-all-form" name="chek_out_all_form" method="post" action="<?php echo e(url('/checkout-from-cart')); ?>">
                                            <?php echo csrf_field(); ?>
            ...
            <?php else: ?>
                    <div class="row">
                            <div class="row empty-cart-image">
                                <img src="<?php echo e(url('public/media/front/img/empty-cart.jpg')); ?>" alt="Empty Cart"/>
                            </div>
                    </div>
            <?php endif; ?>
        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-sender mCustomScrollbar" enctype="multipart/form-data" method="post"
                          action="<?php echo e(url('proceed-customer-shipping-details')); ?>" role="form"
    ...
    <div class="cust-modal manage-modal modal fade in" id="h-quick-view">
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-sender mCustomScrollbar" enctype="multipart/form-data" method="post"
                          action="<?php echo e(url('proceed-shipping-details')); ?>" role="form" name="shipping_details_form"
                          id="shipping-details-form">
                        <?php echo csrf_field(); ?>


                        <input type="hidden" name="ip_cart_id" <?php if(!empty($cart->id)): ?> value="<?php echo e($cart->id); ?>" <?php endif; ?> />
                        <div class="row form-group">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="shipping_name"
                                       <?php if(!empty($cart->shipping_name)): ?> value="<?php echo e($cart->shipping_name); ?>" <?php endif; ?>>
                            </div>
                        </div>
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="shipping_email"
                                       <?php if(!empty($cart->shipping_email)): ?> value="<?php echo e($cart->shipping_email); ?>" <?php endif; ?>>
                            </div>
                        </div>
                        <input type="hidden" name="shipping_iso2" id="shipping_country_code"
                               value="<?php echo e(old('shipping_iso2',isset($cart) ? $cart->shipping_iso2 : "")); ?>"/>
                        <div class="row form-group">
                            <div class="col-md-4">
                                ...
                                <div class="h-cust-sel">
                                    ...
                                    >
                                        ...
                                        <?php if(isset($all_countries)): ?>
                                            ...
                                            <?php foreach($all_countries as $country): ?>
                                                <option class="select-option" label="<?php echo e($country->name); ?>"
                                                        <?php if((isset($cart) && $cart!="") && $cart->shipping_country == $country->id): ?> selected
                                                        <?php endif; ?> value=<?php echo e($country->id); ?>><?php echo e($country->name); ?></option>
                                            <?php endforeach; ?>
                                        <?php endif; ?>
                                    </select>
                        ...
                        <?php /*<div class="row form-group">*/ ?>
                            <?php /*<div class="col-md-4">*/ ?>
                                <?php /*<label class="shipping-label">Region/Province<sup>*</sup> :</label>*/ ?>
                            <?php /*</div>*/ ?>
                            <?php /*<div class="col-md-8">*/ ?>
                                <?php /*<input type="text" class="form-control" id="shipping-state" name="region"*/ ?>
                                       <?php /*<?php if(!empty($cart->shipping_state)): ?> value="<?php echo e($cart->shipping_state); ?>" <?php endif; ?>>*/ ?>
                            <?php /*</div>*/ ?>
                        <?php /*</div>*/ ?>
                        <?php /*<div class="row form-group">*/ ?>
                            <?php /*<div class="col-md-4">*/ ?>
                                <?php /*<label class="shipping-label">City<sup>*</sup> :</label>*/ ?>
                            <?php /*</div>*/ ?>
                            <?php /*<div class="col-md-8">*/ ?>
                                <?php /*<input type="text" class="form-control" id="shipping-city" name="city"*/ ?>
                                       <?php /*<?php if(!empty($cart->shipping_city)): ?> value="<?php echo e($cart->shipping_city); ?>" <?php endif; ?>>*/ ?>
                            <?php /*</div>*/ ?>
                        <?php /*</div>*/ ?>
                        <div class="row form-group">
                            <div class="col-md-4">
                                            ...
                                            <?php if(isset($states) && count($states)>0): ?>
                                                <?php foreach($states as $state): ?>
                                                    <option value="<?php echo e($state->id); ?>"
                                                            <?php if(isset($cart) && $cart->shipping_state == $state->id): ?> selected <?php endif; ?>><?php echo e($state->name); ?></option>
                                                <?php endforeach; ?>
                                            <?php endif; ?>
                                            <option class="select-option" <?php if(!empty($cart->shipping_state) && ($cart->shipping_state == 'Maharashtra')): ?> selected <?php endif; ?> label="Maharashtra" value="Maharashtra">Maharashtra</option>
                                            <option class="select-option" <?php if(!empty($cart->shipping_state) && ($cart->shipping_state == 'Gujarat')): ?> selected <?php endif; ?> label="Gujarat" value="Gujarat">Gujarat</option>
                                            <option class="select-option" <?php if(!empty($cart->shipping_state) && ($cart->shipping_state == 'Madhya Pradesh')): ?> selected <?php endif; ?> label="Madhya Pradesh" value="Madhya Pradesh">Madhya Pradesh</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <?php if(isset($cities) && count($cities)>0): ?>
                                                <?php foreach($cities as $city): ?>
                                                    <option value="<?php echo e($city->id); ?>"
                                                            <?php if(isset($cart) && $cart->shipping_city == $city->id): ?> selected <?php endif; ?>><?php echo e($city->name); ?></option>
                                                <?php endforeach; ?>
                                            <?php endif; ?>
                                            <option class="select-option" <?php if(!empty($cart->shipping_state) && ($cart->shipping_state == 'Maharashtra')): ?> selected <?php endif; ?> label="Maharashtra" value="Maharashtra">Maharashtra</option>
                                            <option class="select-option" <?php if(!empty($cart->shipping_state) && ($cart->shipping_state == 'Gujarat')): ?> selected <?php endif; ?> label="Gujarat" value="Gujarat">Gujarat</option>
                            ...
                            <div class="col-md-8">
                                <div class="h-cust-input">
                                    <input type="text" placeholder="Shipping Address1"
                                           <?php if(isset($cart) && count($cart)>0): ?> value="<?php echo e($cart->shipping_address1); ?>"
                                           <?php endif; ?> class="form-control" name="house_no" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row form-group">
                            <div class="col-md-4">
                                <label class="shipping-label">Shipping Address2<sup>*</sup>:</label>
                            </div>
                            <div class="col-md-8">
                                <div class="h-cust-input">
                                    <input type="text" placeholder="Shipping Address2"
                                           <?php if(isset($cart) && count($cart)>0): ?> value="<?php echo e($cart->shipping_address2); ?>"
                                           <?php endif; ?> class="form-control" name="address_line" required>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-8">
                                <div class="h-cust-input">
                                    <input id="shipping-zip" type="text" placeholder="Postal Code"
                                           <?php if(!empty($cart->shipping_zip)): ?>  value="<?php echo e($cart->shipping_zip); ?>"
                                           <?php endif; ?>   class="form-control" name="postal_code">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-8">
                                <div class="h-cust-input">
                                    <input type="tel" id="shipping-mobile-no" class="form-control"
                                           <?php if(!empty($cart->shipping_telephone)): ?>   value="<?php echo e($cart->shipping_telephone); ?>"
                                           <?php endif; ?>  name="telephone">
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="billing_details" style="display: none">
                            <div class="row form-group">
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="form-control" name="billing_name"
                                           <?php if(!empty($cart->billing_name)): ?> value="<?php echo e($cart->billing_name); ?>" <?php endif; ?>>
                                </div>
                            </div>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="form-control" name="billing_email"
                                           <?php if(!empty($cart->billing_email)): ?> value="<?php echo e($cart->billing_email); ?>" <?php endif; ?>>
                                </div>
                            </div>
                            <input type="hidden" name="billing_iso2" id="billing_country_code"
                                   value="<?php echo e(old('billing_iso2',isset($cart) ? $cart->billing_iso2 : "")); ?>"/>
                            <div class="row form-group">
                                <div class="col-md-4">
                                    <label class="shipping-label">Country<sup>*</sup> :</label>
                                </div>
                                ...
                                <div class="col-md-8">
                                    <div class="h-cust-sel">
                                        <select name="billing_country" id="billing-country"
                                            ...
                                            <?php if(isset($all_countries) && count($all_countries)>0): ?>
                                                <?php foreach($all_countries as $country): ?>
                                                    <option class="select-option" label="<?php echo e($country->name); ?>"
                                                            <?php if(isset($cart) && $cart->shipping_country == $country->id): ?> selected
                                                            <?php endif; ?> value=<?php echo e($country->id); ?>><?php echo e($country->name); ?></option>
                                                    <?php /*<option class="select-option" label="India" <?php if(isset($cart) && $cart->shipping_country == 'India'): ?> selected <?php endif; ?> value="India">India</option>*/ ?>
                                                    <?php /*<option class="select-option" label="United States" <?php if(isset($cart) && $cart->shipping_country == 'United States'): ?> selected <?php endif; ?> value="United States">United States</option>*/ ?>
                                                <?php endforeach; ?>
                                            <?php endif; ?>
                                            <?php /*<option class="select-option" <?php if(!empty($cart->billing_country) && $cart->billing_country == 'Canada'): ?> selected <?php endif; ?> label="Canada" value="Canada">Canada</option>*/ ?>
                                            <?php /*<option class="select-option" <?php if(!empty($cart->billing_country) && $cart->billing_country == 'India'): ?> selected <?php endif; ?> label="India" value="India">India</option>*/ ?>
                                            <?php /*<option class="select-option" <?php if(!empty($cart->billing_country) && $cart->billing_country == 'United States'): ?> selected <?php endif; ?> label="United States" value="United States">United States</option>*/ ?>
                                        </select>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="h-cust-sel">
                                            <select name="billing_region" id="billing-state"
                                                ...
                                                <?php if(isset($states) && count($states)>0): ?>
                                                    <?php foreach($states as $state): ?>
                                                        <option value="<?php echo e($state->id); ?>"
                                                                <?php if(isset($cart) && $cart->billing_state == $state->id): ?> selected <?php endif; ?>><?php echo e($state->name); ?></option>
                                                    <?php endforeach; ?>
                                                <?php endif; ?>
                                                <option class="select-option" <?php if(!empty($cart->billing_state)  && $cart->billing_state == 'Maharashtra'): ?> selected <?php endif; ?> label="Maharashtra" value="Maharashtra">Maharashtra</option>
                                                <option class="select-option" <?php if(!empty($cart->billing_state) && $cart->billing_state == 'Gujarat'): ?> selected <?php endif; ?> label="Gujarat" value="Gujarat">Gujarat</option>
                                                <option class="select-option" <?php if(!empty($cart->billing_state) && $cart->billing_state == 'Madhya Pradesh'): ?> selected <?php endif; ?> label="Madhya Pradesh" value="Madhya Pradesh">Madhya Pradesh</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <?php /*<div class="row form-group">*/ ?>
                                ...
                                <?php /*</div>*/ ?>
                                <?php /*<div class="col-md-8">*/ ?>
                                    <?php /*<input type="text" class="form-control" id="billing-state" name="billing_region"*/ ?>
                                           <?php /*<?php if(!empty($cart->billing_state)): ?> value="<?php echo e($cart->billing_state); ?>" <?php endif; ?>>*/ ?>
                                <?php /*</div>*/ ?>
                            <?php /*</div>*/ ?>
                            <?php /*<div class="row form-group">*/ ?>
                                <?php /*<div class="col-md-4">*/ ?>
                                ...
                                <?php /*</div>*/ ?>
                                <?php /*<div class="col-md-8">*/ ?>
                                    <?php /*<input type="text" class="form-control" id="billing-city" name="billing_city"*/ ?>
                                           <?php /*<?php if(!empty($cart->billing_city)): ?> value="<?php echo e($cart->billing_city); ?>" <?php endif; ?>>*/ ?>
                                <?php /*</div>*/ ?>
                            <?php /*</div>*/ ?>
                            <div class="row form-group">
                                <div class="col-md-4">
                                    ...
                                    <div class="h-cust-input">
                                        <select name="billing_city" id="billing-city" class="form-control" required>
                                            ...
                                            <?php if(isset($cities) && count($cities)>0): ?>
                                                <?php foreach($cities as $city): ?>
                                                    <option value="<?php echo e($city->id); ?>"
                                                            <?php if(isset($cart) && $cart->billing_city !='' && $cart->billing_city == $city->id): ?> selected <?php endif; ?>><?php echo e($city->name); ?></option>
                                                <?php endforeach; ?>
                                            <?php endif; ?>
                                            <option class="select-option" <?php if(!empty($cart->billing_state)  && $cart->billing_state == 'Maharashtra'): ?> selected <?php endif; ?> label="Maharashtra" value="Maharashtra">Maharashtra</option>
                                            <option class="select-option" <?php if(!empty($cart->billing_state) && $cart->billing_state == 'Gujarat'): ?> selected <?php endif; ?> label="Gujarat" value="Gujarat">Gujarat</option>
                                ...
                                <div class="col-md-8">
                                    <div class="h-cust-input">
                                        <input type="text" placeholder="Billing Address1" class="form-control"
                                               <?php if(!empty($cart->billing_address1)): ?>  value="<?php echo e($cart->billing_address1); ?>"
                                               <?php endif; ?>   name="billing_house_no" required>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-8">
                                    <div class="h-cust-input">
                                        <input type="text" placeholder="Billing Address2" class="form-control"
                                               <?php if(!empty($cart->billing_address2)): ?>  value="<?php echo e($cart->billing_address2); ?>"
                                               <?php endif; ?> name="billing_address_line" required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <?php /*<div class="row form-group">*/ ?>
                                ...
                                <?php /*</div>*/ ?>
                                <?php /*<div class="col-md-8">*/ ?>
                                    <?php /*<div class="h-cust-input">*/ ?>
                                        <?php /*<input type="text" id="billing-city" placeholder="City" class="form-control" <?php if(!empty($cart->billing_city)): ?>  value="<?php echo e($cart->billing_city); ?>"   <?php endif; ?>     name="billing_city" required>*/ ?>
                                        <?php /*<select name="billing_city" id="billing-city" class="form-control" required>*/ ?>
                                            <?php /*<option class="select-option" label="Please Select" value="">Please Select*/ ?>
                                            <?php /*</option>*/ ?>
                                            <?php /*<?php */ ?>
                                                <?php /*$cities=null;*/ ?>
                                                 <?php /*if(isset($cart) && $cart->billing_state !=''){*/ ?>
                                                 <?php /*$cities = \App\PiplModules\admin\Models\City::where('state_id',$cart->billing_state)->get();*/ ?>
                                                <?php /*}*/ ?>
                                            <?php /* ?>*/ ?>
                                            <?php /*<?php if(isset($cities) && count($cities)>0): ?>*/ ?>
                                                <?php /*<?php foreach($cities as $city): ?>*/ ?>
                                                    <?php /*<option value="<?php echo e($city->id); ?>"*/ ?>
                                                            <?php /*<?php if(isset($cart) && $cart->billing_city !='' && $cart->billing_city == $city->id): ?> selected <?php endif; ?>><?php echo e($city->name); ?></option>*/ ?>
                                                <?php /*<?php endforeach; ?>*/ ?>
                                            <?php /*<?php endif; ?>*/ ?>
                                            <?php /*<option class="select-option" <?php if(!empty($cart->billing_state)  && $cart->billing_state == 'Maharashtra'): ?> selected <?php endif; ?> label="Maharashtra" value="Maharashtra">Maharashtra</option>*/ ?>
                                            <?php /*<option class="select-option" <?php if(!empty($cart->billing_state) && $cart->billing_state == 'Gujarat'): ?> selected <?php endif; ?> label="Gujarat" value="Gujarat">Gujarat</option>*/ ?>
                                            <?php /*<option class="select-option" <?php if(!empty($cart->billing_state) && $cart->billing_state == 'Madhya Pradesh'): ?> selected <?php endif; ?> label="Madhya Pradesh" value="Madhya Pradesh">Madhya Pradesh</option>*/ ?>
                                        <?php /*</select>*/ ?>
                                    <?php /*</div>*/ ?>
                                <?php /*</div>*/ ?>
                            <?php /*</div>*/ ?>
                            <?php /*<div class="row form-group">*/ ?>
                                ...
                                <?php /*<div class="col-md-8">*/ ?>
                                    <?php /*<div class="h-cust-input">*/ ?>
                                        <?php /*<div class="h-cust-sel">*/ ?>
                                            <?php /*<select name="billing_region" id="billing-state"*/ ?>
                                                    <?php /*onchange="getAllCities(this.value,this.id)" class="form-control"*/ ?>
                                                    <?php /*class="form-control"*/ ?>
                                                    <?php /*required>*/ ?>
                                                <?php /*<option class="select-option" label="Please Select" value="">Please*/ ?>
                                                    <?php /*Select*/ ?>
                                                <?php /*</option>*/ ?>
                                                <?php /*<?php */ ?>
                                                    <?php /*$states =null;*/ ?>
                                                     <?php /*if(isset($cart) && $cart->billing_country !=''){*/ ?>
                                                     <?php /*$states = \App\PiplModules\admin\Models\State::where('country_id',$cart->billing_country)->get();*/ ?>
                                                    <?php /*}*/ ?>
                                                <?php /* ?>*/ ?>
                                                <?php /*<?php if(isset($states) && count($states)>0): ?>*/ ?>
                                                    <?php /*<?php foreach($states as $state): ?>*/ ?>
                                                        <?php /*<option value="<?php echo e($state->id); ?>"*/ ?>
                                                                <?php /*<?php if(isset($cart) && $cart->billing_state == $state->id): ?> selected <?php endif; ?>><?php echo e($state->name); ?></option>*/ ?>
                                                    <?php /*<?php endforeach; ?>*/ ?>
                                                <?php /*<?php endif; ?>*/ ?>
                                                <?php /*<option class="select-option" <?php if(!empty($cart->billing_state)  && $cart->billing_state == 'Maharashtra'): ?> selected <?php endif; ?> label="Maharashtra" value="Maharashtra">Maharashtra</option>*/ ?>
                                                <?php /*<option class="select-option" <?php if(!empty($cart->billing_state) && $cart->billing_state == 'Gujarat'): ?> selected <?php endif; ?> label="Gujarat" value="Gujarat">Gujarat</option>*/ ?>
                                ...
                                <div class="col-md-8">
                                    <div class="h-cust-input">
                                        <input type="text" id="billing-zip" name="billing_postal_code"
                                               ...
                                               <?php if(!empty($cart->billing_zip)): ?>  value="<?php echo e($cart->billing_zip); ?>" <?php endif; ?> >
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-8">
                                    <div class="h-cust-input">
                                        <input type="text" id="billing-mobile-no" name="billing_telephone"
                                               class="form-control"
                                               <?php if(!empty($cart->billing_telephone)): ?>  value="<?php echo e($cart->billing_telephone); ?>" <?php endif; ?>>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <?php if(isset($cart) && !empty($cart->shipping_country) && $cart->is_shipping_details_filled =='1'): ?>
        <?php 
                ...
                <div class="tab-content">
                        ...
                        <div role="tabpanel" class="tab-pane active" id="home1">
                            <div class="my-tab-sld owl-carousel">
                                <?php foreach($all_boxes as $index=>$box): ?>
                                    <div class="item">
                                        <div id="box-container-<?php echo e($box->id); ?>" onclick="boxActive(this)"
                                             class="wrap-container box-containr relative <?php if(isset($cart->box_id) && $cart->box_id == $box->id): ?> selected-wrap <?php endif; ?>">
                                            <div class="wrap-img">
                                                <img src="<?php echo e(url('/storage/app/public/box_image').'/'.$box->image); ?>"/>

                                            </div>
                                            <?php if(isset($box->status) && $box->status=="1"): ?>
                                                <span class="wrap-price"> <?php echo e(App\Helpers\Helper::getCurrencySymbol().number_format(App\Helpers\Helper::getRealPrice(
                                                $box->price),2,'.','')); ?></span>
                                            <?php else: ?>
                                                <span class="wrap-price">FREE</span>
                                            <?php endif; ?>
                                            <div class="wrap-info">
                                                <h3><?php echo e($box->name); ?></h3>
                                                <p><?php echo e($box->description); ?></p>
                                                <?php /*<!-- <a class="alter-box-text" id="ancr-box-tg-<?php echo e($box->id); ?>" onclick="doBox('<?php echo e($box->id); ?>')">Purchase</a> -->*/ ?>
                                            </div>
                            ...
                            <?php /*<div class="added-messges">*/ ?>
                                <?php /*<form class="added-messages">*/ ?>
                                    <?php /*<div class="form-group user-msg relative">*/ ?>
                                        <?php /*<input type="text" name="" class="form-control"*/ ?>
                                               <?php /*placeholder="Enter your message">*/ ?>
                                        <?php /*<span class="apply-btn"><button type="button"*/ ?>
                                                                        <?php /*class="clear-sel apl-btn">Apply</button></span>*/ ?>
                                    <?php /*</div>*/ ?>
                                <?php /*</form>*/ ?>
                            <?php /*</div>*/ ?>
                            ...
                            <?php /*<div class="clear-selection-btn">*/ ?>
                            <?php /*<a href="javascript:void(0);" class="clear-sel">Clear Selection</a>*/ ?>
                            <?php /*<a href="javascript:void(0);" class="clear-sel">Apply Gift Wrap Changes</a>*/ ?>
                            <?php /*</div>*/ ?>
                        </div>
                    <?php endif; ?>
                    <?php if(isset($all_papers) && count($all_papers)>0): ?>
                        <div role="tabpanel" class="tab-pane" id="profile1">
                            <div class="my-tab-sld owl-carousel">
                                <?php foreach($all_papers as $paper): ?>
                                    <div class="item">
                                        <div id="paper-container-<?php echo e($paper->id); ?>" onclick="paperActive(this)"
                                             class="wrap-container paper-containr relative <?php if(isset($cart->paper_id) && $cart->paper_id ==$paper->id): ?> selected-wrap <?php endif; ?> ">
                                            <div class="wrap-img">
                                                <img src="<?php echo e(url('/storage/app/public/paper_image').'/'.$paper->image); ?>"/>
                                            </div>
                                            <?php if(isset($paper->status) && $paper->status=="1"): ?>
                                                <span class="wrap-price"><?php echo e(App\Helpers\Helper::getCurrencySymbol().number_format(App\Helpers\Helper::getRealPrice($paper->price),2,'.','')); ?></span>
                                            <?php else: ?>
                                                <span class="wrap-price">FREE</span>
                                            <?php endif; ?>
                                            <div class="wrap-info">
                                                <h3><?php echo e($paper->name); ?></h3>
                                                <p><?php echo e($paper->description); ?></p>
                                                <?php /*<!-- <a class="alter-paper-text" id="ancr-paper-tg-<?php echo e($paper->id); ?>" onclick="doPaper('<?php echo e($paper->id); ?>')">Purchase</a> -->*/ ?>
                                            </div>
                                            <div class="selct-serv"><i class="fa fa-check"></i></div>
                                        </div>
                                    </div>
                    ...
                    <?php if(isset($all_displays) && count($all_displays)>0): ?>
                        <div role="tabpanel" class="tab-pane" id="messages">
                            <div class="my-tab-sld owl-carousel">
                                <?php foreach($all_displays as $display): ?>
                                    <div class="item">
                                        <div id="msg-card-container-<?php echo e($display->id); ?>" onclick="msgCardActive(this)"
                                             class="wrap-container message-card-containr relative  <?php if(isset($cart->display_id) && $cart->display_id == $display->id): ?> selected-wrap <?php endif; ?> ">
                                            <div class="wrap-img">
                                                <img src="<?php echo e(url('/storage/app/public/display_image').'/'.$display->image); ?>"/>
                                            </div>
                                            <?php if(isset($display->status) && $display->status=="1"): ?>
                                                <span class="wrap-price"><?php echo e(App\Helpers\Helper::getCurrencySymbol().number_format(App\Helpers\Helper::getRealPrice($display->price),2,'.','')); ?></span>
                                            <?php else: ?>
                                                <span class="wrap-price">FREE</span>
                                            <?php endif; ?>
                                            <div class="wrap-info">
                                                <h3><?php echo e($display->name); ?></h3>
                                                <p><?php echo e($display->description); ?></p>
                                            </div>
                                            <div class="selct-serv"><i class="fa fa-check"></i></div>
                                        </div>
                                    </div>
    ...
    <script>
        ...
        {
            $.ajax({
                url: '<?php echo e(url("/fedex/validate-final-rate-request")); ?>',
                type: "get",
                dataType: "json",
    ...
    <link rel="stylesheet" href="<?php echo e(asset('public/media/front/intl-telephone/css/intlTelInput.css')); ?>">
    <script src="<?php echo e(asset('public/media/front/intl-telephone/js/intlTelInput.js')); ?>" type="text/javascript"></script>
    <script type="text/javascript">
        pFlag = false;
        optionVal = '';
        ...
        {
            $.ajax({
                url: '<?php echo e(url("/cart/validate-for-checkout")); ?>',
                type: "get",
                dataType: "json",
                success: function (response) {
        ...
        function checkAmountForPayment(ele)
        {
            ...
            $.ajax(
                {
                    type: "post",
                    url: '<?php echo e(url("/get-cart-grandtotal")); ?>',
                    dataType: 'json',
                    data: {
    ...
    <script>
        function addPromoCode(id) {
            ...
            $.ajax({
                url: '<?php echo e(url("/add-promo-code")); ?>',
                type: "get",
                dataType: "json",
                data: {
    ...
    <script>
        ...
        function getAllStates(country_id, id) {
            ...
            {
                $.ajax({
                    url: "<?php echo e(url('/states/getAllStates')); ?>/" + country_id,
                    method: 'get',
        ...
        {
            $.ajax({
                url: "<?php echo e(url('/country/get-country-info')); ?>/" + country_id,
                method: 'get',
                dataType: "json",
                success: function (response)
                {
        ...
        function getAllCities(state_id, id)
        {
            if (state_id != '' && state_id != 0) {
                $.ajax({
                    url: "<?php echo e(url('/cities/getAllCities')); ?>/" + state_id,
                    method: 'get',
                    success: function (data) {
    ...
    ?>
    <script>
        var countries = '<?php echo e($isoCodes); ?>';
...
//             separateDialCode: true,
            ...
            utilsScript: '<?php echo e(asset('public/media/front/intl-telephone/js/utils.js')); ?>'
        });
...
//             separateDialCode: true,
    ...
    <script>
        function removeBox(id) {
            $.ajax({
                url: '<?php echo e(url("/remove-box-from-cart")); ?>',
                type: "get",
                dataType: "json",
                data: {
                    box_id: id
        ...
        function removePaper(id) {
            $.ajax({
                url: '<?php echo e(url("/remove-paper-from-cart")); ?>',
                type: "get",
                dataType: "json",
                data: {
                    paper_id: id
        ...
        function removeDisplay(id) {
            $.ajax({
                url: '<?php echo e(url("/remove-display-from-cart")); ?>',
                type: "get",
                dataType: "json",
                data: {
                    display_id: id
    ...
    <script>
        function moveToWishlist($cartItemId) {
            ...
            $.ajax({
                url: "<?php echo e(url('/move-product-to-wishlist')); ?>",
                method: 'get',
                dataType: 'json',
                data: {
    ...
    <script>
        function purchaseBox(id) {
            $.ajax({
                url: "<?php echo e(url('/add-box-to-cart')); ?>/" + id,
                type: 'get',
                dataType: "json",
                success: function (response) {
                    if (response.success == "1") {
        ...
        function purchasePaper(id) {
            $.ajax({
                url: "<?php echo e(url('/add-paper-to-cart')); ?>/" + id,
                type: 'get',
                dataType: "json",
                success: function (response) {
                    if (response.success == "1") {
        ...
        function purchaseDisplay(id) {
            $.ajax({
                url: "<?php echo e(url('/add-display-to-cart')); ?>/" + id,
                type: 'get',
                dataType: "json",
                success: function (response) {
                    if (response.success == "1") {
    ...
    <script>
        ...
        function removeGiftCode(id) {
            ...
            $.ajax({
                url: '<?php echo e(url("/remove-gift-code")); ?>',
                type: "get",
                dataType: "json",
                data: {
                    cart_id: cart_id
        ...
        function removePromoCode() {
            $.ajax({
                url: '<?php echo e(url("/remove-promo-code")); ?>',
                type: "get",
                dataType: "json",
                success: function (response) {
                    if (response.success == "1") {
    ...
    <script>
        function addGiftCode(id) {
            ...
            var totSav = $('#total-savings').text();
            $.ajax({
                url: '<?php echo e(url("/add-gift-card")); ?>',
                type: "get",
                dataType: "json",
                data: {
                    gift_code: gift_code,
    ...
    <script>
        ...
        function validatePincode() {
            ...
            $.ajax({
                url: '<?php echo e(url("/fedex/rate-nat-request")); ?>',
                type: "get",
                dataType: "json",
                data: {
                    pin_code: pincode,
        ...
        function validateInternationalPincode() {
            ...
            $.ajax({
                url: '<?php echo e(url("/fedex/rate-int-request")); ?>',
                type: "get",
                dataType: "json",
                data: {
                    pin_code: pincode,
    ...
    <script>
        ...
        function getNationalService(value) {
            ...
            $.ajax({
                url: '<?php echo e(url("/fedex/service-details")); ?>',
                type: "get",
                dataType: "json",
                data: {
                    service_name: name,
        ...
        $(function () {
            ...
            if (chk == 1) {
                $.ajax({
                    url: '<?php echo e(url("/fedex/get-service-details")); ?>',
                    type: "get",
                    dataType: "json",
                    data: {
                        _token: $("[name=_token]").val()
    ...
    <script>
        function getDHLServices(id)
        {
            ...
            $.ajax({
                url: '<?php echo e(url("/dhl/add-service-details")); ?>',
                type: "get",
                dataType: "json",
                data: {
        ...
        function chkDHLServices(id)
        {
           ...
           else if(val == '1')
           {
            ...
            $.ajax({
                url: '<?php echo e(url("/dhl/rate-shipment")); ?>',
                type: "get",
                dataType: "json",
                data: {
                    pin_code: pincode,
    ...
    <script>
        $(function(){
            if('<?php echo e($ctryDetls); ?>' != undefined)
            {
                <?php if(isset($ctryDetls->country_id)): ?>
                    getCountryInfo('<?php echo e($ctryDetls->country_id); ?>');
                <?php endif; ?>
            }
        });
    </script>
