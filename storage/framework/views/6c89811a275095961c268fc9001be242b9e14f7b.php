    ...
    <div class="page-content">
        ...
        <div class="portlet box blue">
            ...
            <div class="portlet-body form">
                <form class="form-horizontal" name="update_display" id="update_display" role="form" action="<?php echo e(url('/admin/update-display/').'/'.$display_details->id); ?>" method="post" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                            ...
                            <div class="col-md-12">    
                                <div class="col-md-8">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" class="form-control" name="display_name" id="display-name" value="<?php echo e($display_details->name); ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="hidden" name="old_image" value="<?php echo e($display_details->image); ?>">
                                            <image id="show_image" style="margin-top: 10px" <?php if(!empty($display_details->image)): ?> src="<?php echo e(url("storage/app/public/display_image/").'/'.$display_details->image); ?>" <?php else: ?> style="display:none"  <?php endif; ?> class="ribbon-image" height="50px" width="50px">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">     
                                            <select name="status" class="form-control" id="status" onchange="hideShowTextbox(this)">
                                                ...
                                                <option <?php if($display_details->status==0): ?> selected <?php endif; ?> value="0">Free</option>
                                                <option <?php if($display_details->status==1): ?> selected <?php endif; ?> value="1">Paid</option>
                                            </select>
                                    ...
                                    <div class="form-group" id="order_price_div" <?php if($display_details->status!=1): ?> style="display:none" <?php endif; ?>>
                                        <label class="col-md-6 control-label">Price<sup>*</sup></label>

                                        <div class="col-md-6">
                                            <input name="price" type="text" class="form-control" onkeyup="callToDiscount()" id="price" value="<?php echo e($display_details->price); ?>">
                                    ...
                                    <div class="form-group <?php if($errors->has('description')): ?> has-error <?php endif; ?>">
                                        ...
                                        <div class="col-md-6">
                                            <textarea name="description" type="text" class="form-control" id="description"><?php echo e($display_details->description); ?></textarea>
