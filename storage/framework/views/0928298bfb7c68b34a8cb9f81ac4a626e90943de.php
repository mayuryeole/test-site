...
<div class="page-content-wrapper">
    ...
    <div class="page-content">
                ...
                <div class="portlet box grey-cascade">
                    ...
                    <div class="portlet-body">
                        <div class="table-toolbar">
                            <?php if(Auth::user()->hasPermission('create.register-users')==true || Auth::user()->isSuperadmin()): ?>
                           
                            <div class="row">
                                <div class="col-md-10">
                                    <div class="btn-group">
                                        <a href="<?php echo e(url('admin/create-registered-user')); ?>" id="sample_editable_add_new" class="btn green">
                                            Add New <i class="fa fa-plus"></i>
                                        </a>
                                    </div>

                                    <div class="btn-group" id="customer-csv">
                                        <a href="<?php echo e(url('admin/customeruser-show-excel')); ?>" id="sample_editable_create_customer_csv" class="btn green">
                                            Export Customer Users 
                                            <i class="fa fa-file-o"></i>
                                        </a>
                                    </div>
                                    <div class="btn-group" id="business-csv">
                                        <a href="<?php echo e(url('admin/businessuser-show-excel')); ?>" id="sample_editable_create_business_csv" class="btn green">
                                    ...
                                    <select name="user" id="user" onchange="selectUser(this.value)">
                                        ...
                                        <option value="1" <?php if($curr_user_type=='1'): ?> selected <?php endif; ?>>All Users</option>
                                        <option value="2"  <?php if($curr_user_type=='3'): ?> selected <?php endif; ?>>All Customer Users</option>
                                        <option value="3" <?php if($curr_user_type=='4'): ?> selected <?php endif; ?>>All Business Users</option>
                                    </select>
                                </div>
        ...
        <?php endif; ?>
                        ...
                        <input type="button" onclick='javascript:deleteAll("<?php echo e(url('/admin/delete-selected-user')); ?>")' name="delete" id="delete" value="Delete Selected" class="btn btn-danger">
                    </div>
                </div>
    ...
    <div class="container">
        ...
        <script>
                            ...
                            if (choice == 1)
                            { 
                            window.location.href = "<?php echo e(url('/admin/manage-users')); ?>";
                            } else if (choice == 2)
                            { 
                            window.location.href = '<?php echo e(url("/admin/manage-users")); ?>/3';
                            } else{ 
                            window.location.href = '<?php echo e(url("/admin/manage-users")); ?>/4';
                            }
        ...
        <script>
                    ...
                    <?php if((Request::segment(3)) != NULL): ?>
                            pass_register_value = "<?php echo e(url('/admin/list-registered-users-data')); ?>" + "/" + "<?php echo e(Request::segment(3)); ?>";
                            <?php else: ?>
                            pass_register_value = "<?php echo e(url('/admin/list-registered-users-data')); ?>";
                            <?php endif; ?>
                            ...
                            {data:   "Update",
                                    ...
                                    return '<a class="btn btn-sm btn-primary" href="<?php echo e(url("admin/update-registered-user/")); ?>/' + row.user_id + '">Update</a>';
                                    }
                                    return data;
                                    },
                                    "orderable": false,
                            ...
                            {data:   "Delete",
                                    ...
                                    return '<form id="delete_user_' + row.user_id + '" method="post" action="<?php echo e(url("/admin/delete-user")); ?>/' + row.user_id + '"><?php echo e(method_field("DELETE")); ?> <?php echo csrf_field(); ?><button onclick="confirmDelete(' + row.user_id + ')" class="btn btn-sm btn-danger" type="button">Delete</button></form>';
                                    }
                                    return data;
                                    },
                                    "orderable": false,
