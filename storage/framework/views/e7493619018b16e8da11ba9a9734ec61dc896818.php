						...
						<div class="portlet-title">
							...
							<div class="table-toolbar">
								...
								<div class="row">
									<div class="col-md-6">
										<div class="btn-group">
											<a href="<?php echo e(url('/admin/category/create')); ?>" id="sample_editable_1_new" class="btn green">
...
$(function() {
    $('#list_categories').DataTable({
        ...
        serverSide: true,
        //bStateSave: true,
        ajax: {"url":'<?php echo e(url("/admin/categories-list-data")); ?>',"complete":afterRequestComplete},
        columnDefs: [{
        "defaultContent": "-",
        "targets": "_all",
           ...
           { data: 'name', name: 'name'},
            ...
            {data:   "Sub Category",
              render: function ( data, type, row ) {
                    ...
                    if ( type === 'display' ) {
                        ...
                        return '<a  class="btn btn-sm btn-primary" href="<?php echo e(url("/admin/subcategories-list")); ?>/'+row.id+'">Sub category</a>';
                    }
                    return data;
                },
                  "orderable": false,
            ...
            {data:   "Update",
              render: function ( data, type, row ) {
                    ...
                    if ( type === 'display' ) {
                        str="";
                        str='<a  class="btn btn-sm btn-primary" href="<?php echo e(url("/admin/category")); ?>/'+row.id+'">Update</a>';
                        str+='<a  class="btn btn-sm btn-primary" href="<?php echo e(url("/admin/manage-category-discounts")); ?>/'+row.id+'">Manage Discounts</a>';
                        str+='<a  class="btn btn-sm btn-primary" href="<?php echo e(url("/admin/manage-category-attributes")); ?>/' + row.id + '">Manage Attributes</a>';
                        return str;
                    }
                    return data;
                },
