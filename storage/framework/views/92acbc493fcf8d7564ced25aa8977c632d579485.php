                            ...
                            <div class="col-md-12">    
                                <div class="col-md-8">  
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">     
                                            <input name="style_name" type="text" class="form-control" id="style_name" value="<?php echo e($style->name); ?>" />
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-md-6">     
                                            <input name="photo" type="file" class="form-control" id="photo" value="<?php echo e($style->image); ?>" />
                                            <img name="imagePreview" id="imagePreview" style="width: 50px;height: 50px" src="<?php echo e(url('storage/app/public/style/thumbnails')); ?>/<?php echo e($style->image); ?>"/>
