...
<section class="registration_blk fullHt">
    ...
    <div class="login_form forgot_pass">        
        <form class="form_login" role="form" method="POST" action="<?php echo e(url('/password/email')); ?>">
            <?php echo csrf_field(); ?>
            ...
            <p class="create_ac_link text-center"><a href="<?php echo e(url('/login')); ?>">Back to Login</a></p>
        </form>        
    </div>
</section>
