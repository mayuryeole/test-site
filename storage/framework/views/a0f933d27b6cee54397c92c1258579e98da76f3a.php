                            ...
                            <div class="col-md-12">    
                                <div class="col-md-8">  
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <input name="old_name" type="hidden" class="form-control" id="old_name" value="<?php echo e($collection_style->name); ?>" />
                                            <input name="collection_style_name" type="text" class="form-control" id="collection_style_name" value="<?php echo e($collection_style->name); ?>" />
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-md-6">     
                                            <input name="photo" type="file" class="form-control" id="photo" value="<?php echo e($collection_style->image); ?>" />
                                            <img id="imagePreview" style="width: 50px;height: 50px" src="<?php echo e(url('/storage/app/public/collection-style/thumbnails/'.$collection_style->image)); ?>"/>
