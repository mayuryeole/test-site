...
<head> 
    ...
    <link rel="stylesheet" href="<?php echo e(url('public/media/front/css/style.css')); ?>">
    
    <script type="text/javascript"  src="<?php echo e(url('public/media/front/js/jquery-v2.1.3.js')); ?>"></script>
        ...
        <div class="container">
			...
			<?php if(Auth::User()->userInformation->user_type=='1'): ?>	
                <a class="navbar-brand" href="<?php echo e(url('/admin/dashboard')); ?>">
                   <?php echo e(GlobalValues::get('site-title')); ?>
