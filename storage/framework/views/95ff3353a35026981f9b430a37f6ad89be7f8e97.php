...
<section class="invoice" style="border: 1px solid #e5e5e5; box-shadow: 0 0 10px #e5e5e5; margin: 50px auto; padding: 10px 10px 50px; width: 100%;font-size: 14px;letter-spacing: 0.5px;">
    ...
    <table class="table" style="width: 100%;" cellspacing="0">
        <tr>
            <td style="width:33.3%; padding:0px 10px;vertical-align:top;">
                <p class="order-id" style="font-weight:bold;line-height: 30px;margin: 0px;font-size: 14px;">Order ID: <span style="font-weight:400;"><?php echo e($order->sku); ?></span></p>
                <p class="order-date" style="font-weight:bold;line-height: 30px;margin: 0px;font-size: 14px;">Order Date: <span style="font-weight:400;"><?php echo e($order->created_at); ?></span></p>
                <p class="invoice-date" style="font-weight:bold;line-height: 30px;margin: 0px;font-size: 14px;">Invoice Date: <span style="font-weight:400;"><?php echo e($order->created_at); ?></span></p>
            ...
            <td style="width:33.3%; padding:0px 10px;vertical-align:top;">
                ...
                <p class="bill-addr-detail" style="font-weight:400;font-size: 14px;margin: 0px;line-height: 23px;"><?php echo e($order->shipping_address1); ?>,<?php echo e($order->billing_city); ?>,<?php echo e($order->billing_state); ?>,<?php echo e($order->billing_country); ?><?php echo e($order->billing_zip); ?></p>
            </td>
            <td style="width:33.3%; padding:0px 10px;vertical-align:top;">
                <p class="shipp-addr" style="font-weight:bold;margin: 0px;font-size: 14px;line-height: 35px">Shipping Address: </p>
                <p class="shipp-addr-detail" style="font-weight:400;font-size: 14px;margin: 0px;line-height: 23px;"><?php echo e($order->shipping_address1); ?>,<?php echo e($order->shipping_city); ?>,<?php echo e($order->shipping_state); ?>,<?php echo e($order->shipping_country); ?><?php echo e($order->shipping_zip); ?></p>
            </td>
        </tr>
        <tr>
            <td>
    ...
    <table class="table" cellspacing="0" style="padding: 0px 10px;margin-top: 25px; width: 100%;">
        ...
        <tr>
            <td> <?php if(!empty($item->product->name)): ?><?php echo e($item->product->name); ?> <?php endif; ?></td>
            <td><?php if(!empty($item->product->productDescription->sku)): ?> <?php echo e($item->product->productDescription->sku); ?> <?php endif; ?></td>
            <td style="text-align:right;"><?php if(!empty($item->product_quantity)): ?> <?php echo e($item->product_quantity); ?> <?php endif; ?></td>
            <td style="text-align:right;"><?php if(!empty($item->product_amount)): ?> <?php echo e(number_format($item->product_amount,2,'.','')); ?> <?php endif; ?></td>
            <td style="text-align:right;"><?php if(!empty($item->product_color_name)): ?> <?php echo e($item->product_color_name); ?> <?php endif; ?></td>
            <td style="text-align:right;"><?php if(!empty($item->product_size_name)): ?> <?php echo e($item->product_size_name); ?> <?php endif; ?></td>
            <td style="text-align:right;"> <?php if(!empty($item->product_quantity) && !empty($item->product_amount)): ?> <?php echo e(number_format($item->product_quantity * $item->product_amount,2,'.','')); ?> <?php endif; ?></td>
        </tr>
            <?php endforeach; ?>
        <?php endif; ?>
        <tr>
        ...
        <?php if(!empty($order->order_subtotal) && $order->order_subtotal !=''): ?>
        <tr>
            ...
            <td colspan="2" style="text-align:right;font-size: 14px; border-top: 1px solid #1e1e1e; line-height: 50px; font-weight: bold;"><?php echo e(number_format($order->order_subtotal,2,'.','')); ?></td>
        </tr>
        <?php endif; ?>
        ...
        <tr>
            ...
            <td colspan="2" style="text-align:right;font-size: 14px; line-height: 30px; font-weight: normal;"><?php echo e(number_format($order->order_shipping_cost,2,'.','')); ?></td>
        </tr>
        <?php endif; ?>
        ...
        <tr>
            ...
            <td colspan="2" style="text-align:right;font-size: 14px; line-height: 30px; font-weight: normal;"><?php echo e(number_format($order->coupon_amount,2,'.','')); ?></td>
        </tr>
        <?php endif; ?>
        ...
        <tr>
            ...
            <td colspan="2" style="text-align:right;font-size: 14px; line-height: 30px; font-weight: normal;"><?php echo e(number_format($order->gift_card_amount,2,'.','')); ?></td>
        </tr>
        <?php endif; ?>
        <?php if(!empty($order->box_amount) || !empty($order->paper_amount)): ?>
        <tr>
            <td colspan="5" style="text-align:right;font-size: 14px; line-height: 30px; font-weight: normal;"> Total Packaging Cost:</td>
            <td colspan="2" style="text-align:right;font-size: 14px; line-height: 30px; font-weight: normal;"><?php echo e(number_format((floatval($order->box_amount)+floatval($order->paper_amount)),2,'.','')); ?></td>
        </tr>
        <?php endif; ?>
        <?php if(!empty($order->display_amount)): ?>
        <tr>
            <td colspan="5" style="text-align:right;font-size: 14px; line-height: 30px; font-weight: normal;"> Display Amount:</td>
            <td colspan="2" style="text-align:right;font-size: 14px; line-height: 30px; font-weight: normal;"><?php echo e(number_format($order->display_amount,2,'.','')); ?></td>
        </tr>
        <?php endif; ?>
        <?php if(!empty($order->order_tax)): ?>
        <tr>
            <td colspan="5" style="text-align:right;font-size: 14px; line-height: 30px; font-weight: normal;"> Total Taxes:</td>
            <td colspan="2" style="text-align:right;font-size: 14px; line-height: 30px; font-weight: normal;"><?php echo e(number_format($order->order_tax,2,'.','')); ?></td>
        </tr>
        <?php endif; ?>
        <?php if(!empty($order->order_discount)): ?>
        <tr>
            <td colspan="5" style="text-align:right;font-size: 14px; line-height: 30px; font-weight: normal;"> Total Savings:</td>
            <td colspan="2" style="text-align:right;font-size: 14px; line-height: 30px; font-weight: normal;"><?php echo e(number_format($order->order_discount,2,'.','')); ?></td>
        </tr>
        <?php endif; ?>
        <?php if(!empty($order->order_subtotal)): ?>
        <tr>
            ...
            <td colspan="2" style="text-align:right;font-size: 22px;border-top: 1px solid #1e1e1e;border-bottom: 1px solid #1e1e1e;line-height: 30px;"> <?php echo e(number_format($order->order_total,2,'.','')); ?></td>
        </tr>
        <?php endif; ?>
    </table>
