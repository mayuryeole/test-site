      ...
      <!-- BEGIN SAMPLE FORM PORTLET-->
        <div class="portlet box blue">
             ...
             <div class="portlet-body form">
                 <form class="form-horizontal" role="form" action="" method="post" id="update_faq" >
                   ...
                   <div class="row">
                        ...
                        <div class="col-md-8">  
                         <div class="form-group <?php if($errors->has('question')): ?> has-error <?php endif; ?>">
                          <label class="col-md-6 control-label">Question<sup>*</sup></label>
                            ...
                            <div class="col-md-6">     
                           <input class="form-control" name="question" value="<?php echo e(old('question',$faq->question)); ?>" />
                       ...
                       <div class="form-group <?php if($errors->has('answer')): ?> has-error <?php endif; ?>">
                          <label class="col-md-6 control-label">Answer<sup>*</sup></label>
                            ...
                            <div class="col-md-6">     
                                <textarea class="form-control" name="answer" ><?php echo e(old('answer',$faq->answer)); ?></textarea>
