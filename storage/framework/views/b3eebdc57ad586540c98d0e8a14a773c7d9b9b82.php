...
<link href="<?php echo e(url('public/media/backend/css/lock.css')); ?>" rel="stylesheet" type="text/css"/>
...
<script src="<?php echo e(url('public/media/backend/js/jquery.validate.js')); ?>" type="text/javascript"></script>
<script src="<?php echo e(url('public/media/backend/js/validation.js')); ?>" type="text/javascript"></script>
</body>
</html>