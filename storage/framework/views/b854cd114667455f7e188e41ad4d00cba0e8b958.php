                            ...
                            <div class="blog-inf-blk clearfix">
                                ...
                                <div class="blog-info-holder">
                                    <div class="blog-uploader clearfix">
                                        ...
                                        <div class="bl-upl-img"><img src="<?php echo e(asset('storage/app/public/blog/thumbnails/'.$post->post_image)); ?>" /></div>
                                        <?php endif; ?>
                                        <a href="<?php echo e(url('/blog/'.$post->post_url)); ?>"><div class="bl-upl-inf"><?php echo e($post->title); ?></div></a>
                                        <div class="blog-date">
                                    ...
                                    <div class="blog-desc">
                                        ...
                                        <a href="<?php echo e(url('/blog/'.$post->post_url)); ?>">View Comments</a>
                                    </div>
