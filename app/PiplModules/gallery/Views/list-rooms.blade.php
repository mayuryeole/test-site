...
<div class="page-content-wrapper">
    <div class="page-content">
        ...
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li>
                <a href="javascript:void(0)">Manage Rooms</a>
            ...
            <div class="col-md-12">
                ...
                <div class="portlet box grey-cascade">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="fa fa-list"></i>Manage Rooms
                        </div>
                        <div class="tools">
                    ...
                    <div class="portlet-body">
                        <div class="table-toolbar">
                            <!--                            @if(Auth::user()->hasPermission('create.rooms')==true || Auth::user()->isSuperadmin())
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="btn-group">
                                                                    <a href="{{url('/admin/rooms/create')}}" id="sample_editable_1_new" class="btn green">
    ...
    <script>
        $(function() {
            $('#list_categories').DataTable({
                ...
                serverSide: true,
                //bStateSave: true,
                ajax: {"url": '{{url("/admin/rooms-list-data")}}', "complete": afterRequestComplete},
                columnDefs: [{
                        "defaultContent": "-",
                        "targets": "_all",
                    }],
...
//                        },
                    {data: 'id', name: 'id'},
                    {data: 'new_room_name', name: 'new_room_name'},
                    ...
                    {data: "Update",
                        render: function(data, type, row) {
                            ...
                            if (type === 'display') {
                                ...
                                return '<a  class="btn btn-sm btn-primary" href="{{url("/admin/rooms")}}/' + row.user_id + '">Update</a>';
                            }
                            return data;
                        },
                        "orderable": false,
