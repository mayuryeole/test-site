                    ...
                    @endif 
                        ...
                        <div class="form-group @if ($errors->has('photo')) has-error @endif">
                          <label class="col-md-6 control-label">Image<sup>*</sup></label>
                            <div class="col-md-6">
                              <div class="@if(!empty($ori_post->post_image)) input-group @endif"> @if(!empty($ori_post->post_image))<span class="input-group-addon" id="basic-addon3"><img src="{{asset('storage/app/public/blog/thumbnails/'.$ori_post->post_image)}}" height="20" style="cursor:pointer" onclick="window.open('{{asset('storage/app/public/blog/'.$ori_post->post_image)}}','Image','width=200,height=200,left=('+screen.width-200+'),top=('+screen.height-200+')')" /></span>@endif
                     ...
                     <div class="form-group @if ($errors->has('post_status')) has-error @endif">
                          <label class="col-md-6 control-label">Publish Status<sup>*</sup></label>
                            <div class="col-md-6">     
                             <label class="radio-inline"><input type="radio" name="post_status" value="1" @if(old('post_status',$ori_post->post_status)=='1') checked="checked" @endif required>Published</label> <label class="radio-inline"><input type="radio" name="post_status" value="0"  @if(old('post_status',$ori_post->post_status)=='0') checked="checked" @endif>Not Published</label>
