                    ...
                    <div class="form-group">
                       ...
                       <div class="form-group">
                          <label class="col-md-6 control-label">Parent Category</label>
                            ...
                            <div class="col-md-6">     
                                <select class="form-control my_select" name="parent_id" value="{{old('parent_id')}}">
                                <option value="0">No Parent</option>
                                 @foreach($tree as $ls_category)
                                 <option value="{{$ls_category->id}}" @if(old('parent_id')==$ls_category->id) selected="selected" @endif>{{$ls_category->display}}</option>
                                 @endforeach
                             </select>
