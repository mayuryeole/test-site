    ...
    <div class="page-content">
        ...
        <div class="portlet box blue">
            ...
            <div class="portlet-body form">
                <form class="form-horizontal" name="create_box" id="create_box" role="form" action="{{url('/admin/box/create' )}}" method="post" enctype="multipart/form-data">
                    {!! csrf_field() !!}
                    <div class="form-body">
                        <div class="row">
                            <div class="col-md-12">    
                                <div class="col-md-8">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" class="form-control" name="box_name" id="box-name" value="{{old('box_name')}}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" class="form-control" name="box_weight" id="box-weight" value="{{old('box_weight')}}">
