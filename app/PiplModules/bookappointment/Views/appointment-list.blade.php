					...
					<div class="portlet box grey-cascade">
						...
						<div class="table-toolbar">
								<div class="row">
									<div class="col-md-6">
										<div class="btn-group">
											<a href="{{url('get-appointment/availabily')}}" id="sample_editable_1_new" class="btn green">
							...
							<tr>
									...
									<div class="cust-chqs">  <p><input type="checkbox" id="select_all_delete" ><label for="select_all_delete"></label>  </p></div>
                                                        ...
                                                        <!--<input type="button" onclick='javascript:deleteAll("{{url('admin/contact-mode/delete-selected')}}")' name="delete" id="delete" value="Delete Selected" class="btn btn-danger">-->
						</div>
					</div>
...
$(function() {
    $('#tblcities').DataTable({
        ...
        serverSide: true,
         //bStateSave: true,
        ajax: {"url":'{{url("/admin/manage-appointment-data")}}',"complete":afterRequestComplete},
        columnDefs: [{
        "defaultContent": "-",
        "targets": "_all"
      }],
            ...
            {data:   "View",
              render: function ( data, type, row ) {
                    ...
                    if ( type === 'display' ) {
                        ...
                        return '<a class="btn btn-sm btn-primary" href="{{url("admin/manage-appointments/view-detail")}}/'+row.id+'">View Detail</a>';
                    }
                    return data;
                },
                  "orderable": false,
