                        ...
                        <div class="row">
                            <div class="col-md-12">    
                                <div class="col-md-8">  
                                    ...
                                    <div class="form-group @if ($errors->has('collection_style_name')) has-error @endif">
                                        <label class="col-md-6 control-label">Collection Style Name<sup>*</sup></label>
                                        <div class="col-md-6">     
                                            <input name="collection_style_name" type="text" class="form-control" id="collection_style_name" value="{{old('collection_style_name')}}">
