                        ...
                        <div class="row">
                            <div class="col-md-12">    
                                <div class="col-md-8">  
                                    ...
                                    <option @if (old('category',$product_description->category_id)==$ls_category->id) selected="selected" @endif value="{{$ls_category->id}}">{{$ls_category->display}}</option>
                                    @endforeach
                                                @endif
                                            </select>
                                         </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <input name="product_sku" type="text" class="form-control" id="product_sku" value="{{$product_description->sku}}" />
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-md-6">   
                                        <div class="@if(!empty($product_description->image)) input-group @endif">
                                            @if(!empty($product_description->image))<span class="input-group-addon" id="basic-addon3">
                                                <img src="{{asset('storage/app/public/product/image/thumbnail/'.$product_description->image)}}" height="20" style="cursor:pointer" onclick="window.open('{{asset('storage/app/public/product/image/thumbnail'.$product_description->image)}}','Image','width=200,height=200,left=('+screen.width-200+'),top=('+screen.height-200+')')" />
                                            </span>@endif
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            @if(!empty($product_description->video))
                                                <span class="input-group-addon" id="basic-addon3">{{ $product_description->video }}</span>
                                            @endif
                                    ...
                                    @if(isset($countries) && count($countries)>0)
                                        <div class="form-group @if ($errors->has('productCountry')) has-error @endif">
                                            <label class="col-md-6 control-label">Country</label>
                                            <div class="col-md-6">
                                                <select id="product-country" multiple="multiple" name="productCountry[]">

                                                    @foreach($countries as $country)
                                                        <option value="{{ $country->id }}" name="productCountry" @if(isset($product_country) && in_array($country->id,$product_country) == true) selected @endif>{{ $country->trans->name }}</option>
                                                    @endforeach
                                                </select>
                                                {{--<input type="button" id="btnSelected" value="Get Selected" />--}}
                                                @if ($errors->has('productCountry'))
                                                    <span class="help-block">
                                                <strong class="text-danger">{{ $errors->first('productCountry') }}</strong>
                                            </span>
                                                @endif
                                            </div>
                                        </div>
                                    ...
                                    @if(isset($colors) && count($colors)>0)
                                        <div class="form-group @if ($errors->has('productColor')) has-error @endif">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <select id="productColor" name="productColor[]">
                                                    ...
                                                    @foreach($colors as $color)
                                                        <option value="{{ $color->name }}" name="productColor" @if(isset($product_description->color) &&  $product_description->color == $color->name) selected @endif>{{ $color->name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                                @if ($errors->has('productColor'))
                                                    <span class="help-block">
                                                <strong class="text-danger">{{ $errors->first('productColor') }}</strong>
                                            </span>
                                                @endif
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6"> 
                                            <div class="h-color-select">  
                                             <select id="color" multiple="multiple" name="color[]">
                                                 ...
                                                 @foreach($colors as $color)
                                                     <option value="{{ $color->name }}" name="color" @if(isset($product_color) && in_array($color->name,$product_color) == true) selected @endif>{{ $color->name }}</option>
                                                 @endforeach
                                             </select>
                                         </div>
                                            {{--<input type="button" id="btnSelected" value="Get Selected" />--}}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">     
                                            <input name="quantity" type="text" class="form-control" id="quantity" value="{{$product_description->quantity}}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <input name="order_quantity" type="text" class="form-control" id="order_quantity" value="{{$product_description->max_order_qty}}">
                                            @if ($errors->has('quantity'))
                                                <span class="help-block">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">  
                                            <select class="form-control" id="hide_product" name="hide_product">
                                                ...
                                                <option value="0" @if(isset($product_description->hide_product) && $product_description->hide_product==0) selected="selected" @endif >Hide from Customer/Guest User</option>
                                                <option value="1" @if(isset($product_description->hide_product) && $product_description->hide_product==1) selected="selected" @endif>Hide from Business/Guest User</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">  
                                            <select class="form-control" id="hide_product_price" name="hide_product_price">
                                                <option value="3" @if(isset($product_description->hide_product) && $product_description->hide_product==3) selected="selected" @endif>Select User Type</option>
                                                <option value="0" @if(isset($product_description->hide_product_price) && $product_description->hide_product_price==0) selected="selected" @endif >Hide from Customer/Guest User</option>
                                                <option value="1" @if(isset($product_description->hide_product_price) && $product_description->hide_product_price==1) selected="selected" @endif>Hide from Business/Guest User</option>
