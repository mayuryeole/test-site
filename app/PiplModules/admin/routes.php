...
Route::group(array('module'=>'Admin', 'namespace' => 'App\PiplModules\admin\Controllers','middleware'=>'web','as'=>'admin::'), function() {
	...
	Route::get("/admin","AdminController@showLogin");
        ...
        Route::get("/admin/customeruser-show-excel","AdminController@downloadExcel")->middleware('permission:view.registered-users');
        Route::get("/admin/businessuser-show-excel","AdminController@downloadBusinessExcel")->middleware('permission:view.registered-users');
	...
	Route::post("/admin/change_verify_status", "AdminController@changeVerifyStatus");
	...
	//Manage Global Settings end
        ...
        Route::get("/admin/manage-users/{user_type}","AdminController@listRegisteredUsers")->middleware('permission:view.registered-users');
        Route::get("/admin/list-registered-users-data/{user_type?}","AdminController@listRegisteredUsersData")->middleware('permission:view.registered-users');
        #Route::get("/admin/list-customer-users-data","AdminController@listCustomerUsersData");
        #Route::get("/admin/list-business-users-data","AdminController@listBusinessUsersData");
	...
	Route::get("/admin/create-registered-user","AdminController@createRegisteredUser")->middleware('permission:create.register-users');
	Route::post("/admin/create-registered-user","AdminController@createRegisteredUser")->middleware('permission:create.register-users');
    ...
    Route::get("/states/getAllStates/{country_id}","AdminController@getAllStatesByCountry");
    ...
    Route::get("/cities/getAllCities/{state_id}","AdminController@getAllCitiesByState");
	...
	//Manage cities end here	
        Route::post("/get-city","AdminController@getAllCountryCity");
	Route::post("/select-state","AdminController@getStates");
	Route::post("/select-city","AdminController@getCities");
	Route::get('/country/get-country-info/{country_id}',"AdminController@getCountryInfo");
    ...
    Route::get('/check-duplicate-city','AdminController@chkDuplicateCity');
    Route::get('/check-duplicate-state','AdminController@chkDuplicateState');
    Route::get('/check-duplicate-country','AdminController@chkDuplicateCountry');
    Route::get('/user/product-rate-request/{product_id}','AdminController@userProductRateRequest');
