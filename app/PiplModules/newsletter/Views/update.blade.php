                   ...
                   <div class="row">
                      ...
                      <div class="col-md-9">  
                         <div class="form-group  @if ($errors->has('subject')) has-error @endif">
                          ...
                          <div class="form-group  @if ($errors->has('nl_content')) has-error @endif">
                          <label for="page_content" class="col-md-3 control-label">Contents<sup>*</sup></label>
                       
                            <div class="col-md-9">     
                            <textarea class="form-control" name="nl_content">{{old('nl_content',$newsletter->content)}}</textarea>
                           @if ($errors->has('nl_content'))
                                    <span class="help-block">
                                        <strong class="text-danger">{{ $errors->first('nl_content') }}</strong>
                                    </span>
                            @endif
                          </div>
                      </div>
