                ...
                <div class="portlet box grey-cascade">
                    ...
                    <div class="portlet-body">
                        <div class="table-toolbar">
                            @if(Auth::user()->hasPermission('create.newsletter')==true || Auth::user()->isSuperadmin())
                        ...
                        <input type="button" onclick='javascript:deleteAll("{{url('/admin/newsletter/delete-selected')}}")' name="delete" id="delete" value="Delete Selected" class="btn btn-danger">
                    </div>
                </div>
    ...
    <script>
        ...
        processing: true,
                ...
                {data:   "Send",
                        ...
                        return '<a  class="btn btn-sm btn-primary" href="{{url("/admin/select-newsletter-users/")}}/' + row.id + '">Send</a>';
                        }
                        return data;
                        },
                        "orderable": false,
