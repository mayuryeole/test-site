...
<title>Update Story Category</title>
...
<div class="page-content-wrapper">
    <div class="page-content">
        ...
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li>
                <a href="{{url('admin/story-categories')}}">Manage Story Categories</a>
                <i class="fa fa-circle"></i>

            </li>
            <li>
                <a href="javascript:void(0);">Update Story Category</a>
        ...
        <div class="portlet box blue">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-gift"></i>Update Story Category
                </div>
