                        ...
                        <div class="col-md-8">  
                         <div class="form-group @if ($errors->has('name')) has-error @endif">
                          <label class="col-md-6 control-label">Name<sup>*</sup></label>
                            ...
                            <div class="col-md-6">
                                <input  name="old_name" type="hidden" class="form-control" id="old_name" value="{{stripslashes($attribute->name)}}" />
                            <input name="name" type="text" class="form-control" id="name" value="{{old('name',stripslashes($attribute->name))}}" />
                            @if ($errors->has('name'))
